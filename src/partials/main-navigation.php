<nav class="main-nav">
  <a href="/" class="logo" title="Zur Startseite von CallOne">
    <img src="/assets/images/logo/Logo.svg" alt="Logo" title="CallOne"/>
  </a>
  <ul class="menu">
    <li>
      ...
      <div class="submenu submenu-products">
        <div class="submenu-content">
          ...
          <ul>
            <li>
              <a href="/callcenter-loesung" class="product" title="Virtuelle Callcenter Lösung für Sales und Service">
              	<span class="img">

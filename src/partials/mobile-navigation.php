...
<nav class="mobile-nav">
  ...
  <ul class="pages-menu">
    ...
    <?php if (!empty ($jobs)): ?>
    <li>
      <a class="submenu" href="/karriere-bei-callone">Karriere</a>
      <ul class="pages-submenu product-menu">
        <?php
  ...
  <div class="buttons">
    <a href="#" data-openmodal="contact-sales" class="button primary" title="Angebot einholen">Angebot einholen</a>

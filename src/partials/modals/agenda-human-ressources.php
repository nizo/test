<div class="callone-modal callone-modal--no-padding" data-modal="agenda-human-ressources" data-title="Tagesagenda" data-subtitle="Human Ressources">
    <div class="agenda">
        ...
        <div class="agenda__row">
            <div class="agenda__col">
                ...
                <div class="agenda__item agenda__item--red agenda__item--computer">
                    Eingegangene Bewerbungen sichten und Gesprächstermine planen
                </div>
            </div>
            <div class="agenda__col">
        ...
        <div class="agenda__row">
            <div class="agenda__col">
                ...
                <div class="agenda__item agenda__item--red agenda__item--computer">
                    Unternehmenspräsentation anpassen
                </div>
            </div>
            <div class="agenda__col">
                <div class="agenda__item agenda__item--red agenda__item--computer">
                ...
                <div class="agenda__item agenda__item--blue agenda__item--exchange">
                    Ergebnisse der Gespräche vorstellen
                </div>
                <div class="agenda__item agenda__item--yellow agenda__item--exchange">
                    MitarbeiterInnenentwicklung planen
                </div>
            </div>
        </div>

<div class="callone-modal callone-modal--no-padding" data-no-header="true" data-modal="video-tableau" data-title="Tableau-Connector">
    <div class="video">
    ...
    <script>
        let video = document.querySelector('#videoTableau');
        video.play();
        video.muted = false;
    </script>
</div>
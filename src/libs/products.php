...
class product
{
	...
	{
		$review = new review ('2021-06-08', null, 'Юсуп Адамович');
		$review->text_set ('👍👍👍👍👍');
		$this->review_add ($review);

		$review = new review ('2021-01-10', 'BUNZL Healthcare', null);
		...
		$review = new review ('2019-05-01', 'Snipes', 'Dennis Voth');
		...
		$review = new review ('2019-04-04', 'Check24', 'Dr. Rainer Klipp');
		...
		$review = new review ('2019-03-27', 'apo-discounter.de', 'Dennis Voth');
		...
		$review = new review ('2016-07-11', null, 'Sebastian Merkhoffer');
		$review->text_set ('Alles top!');
		$this->review_add ($review);

		$review = new review ('2016-02-13', null, 'Babett Schultze');
		...
		$review = new review ('2015-09-17', null, 'Sylvia Hilscher');
		...
		$review = new review ('2015-08-20', 'navabi', 'Leonie Theißen');
		...
		$review = new review ('2015-08-16', 'TCI Rechtsanwälte', 'Stephan Schmidt');
		...
		$review = new review ('2015-07-30', 'Flaconi GmbH', null);
		...
		$review = new review ('2015-07-12', null, 'Felix Schmidt');
		...
		$review = new review ('2015-06-29', null, 'Ingo Vigneron');
		...
		$review = new review ('2015-06-18', null, 'Holger Lerch');
		...
		$review = new review ('2015-06-02', null, 'Tim Vogt');
		...
		$review = new review ('2015-05-25', null, 'Tu-Binh Dang');
		...
		$review = new review ('2015-04-20', null, 'Arek Radziejewski');
		...
		$review = new review ('2015-03-27', null, 'Wytze Kempenaar');
	...
	function structured_data_get_raw ()
	{
		...
		$aggregate_rating['reviewCount']	= (count ($this->reviews_get()) ? count ($this->reviews_get()) : 1);
...
class review
{
	...
	function __construct ($date, $company, $author)
	{
		$this->date		= $date;

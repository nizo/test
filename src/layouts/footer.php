        ...
        <div class="footer-content mobile">
            <div class="company">
                ...
                <div class="button-set centered">
                    <a href="#" class="btn btn--primary btn--full-width centered trackedElement" data-openmodal="contact-sales" data-label="Button footer - FÜR DEMO ANMELDEN​" data-category="Link" data-action="opens sales modal">FÜR DEMO ANMELDEN​</a>
                </div>
            </div>

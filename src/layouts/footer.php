    ...
    <?php if ($_SERVER['REQUEST_URI'] === '/' || $_SERVER['REQUEST_URI'] === '/callcenter-software') : ?>
    	<?php // nothing ?>
    <?php else : ?>
        <div class="wrapper">
    ...
    <footer class="main-footer" style="<?= $_SERVER['REQUEST_URI'] === '/' || $_SERVER['REQUEST_URI'] === '/callcenter-software'? 'margin-top: 0;' : '' ?>">

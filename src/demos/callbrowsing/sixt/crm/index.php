...
?>
<!DOCTYPE html>
<!-- saved from url=(0053)https://callone-sandbox-9094f5.pipedrive.com/person/1 -->
...
<div class="user-profile-corner" onselectstart="return false;">
	...
	<div class="contextSupport icon-button"><div><a href="https://callone-sandbox-9094f5.pipedrive.com/person/1#" class="contextSupport__switcher"><svg class="cui4-icon cui4-icon--black-32"><use href="#icon-help" xlink:href="#icon-help"></use></svg></a></div></div>
	...
	<a href="https://callone-sandbox-9094f5.pipedrive.com/person/1#" data-dropmenu="profile" data-noactive="true" class="profilePictureTooltip"><img src="./data/profile_120x120_2296758_f50241dab5b46a186fada0e886d2f5d1.jpg">
		<div class="userInfo">
			<span class="name" data-test="name">CallOne</span>
			<span class="company" data-test="company">CallOne GmbH</span>
		</div>
...
<div class="menuWrapper">
	<div id="mainmenu" class="clearfix">
		<menu class="mainmenu" style="float: left">
			<div class="logo_container"><h1 class="logo"><a href="https://callone-sandbox-9094f5.pipedrive.com/">Pipedrive</a></h1></div>
			...
			<div id="global-search" style="display: block;">
				...
				<li class="index-0 key-pipeline"><a href="https://callone-sandbox-9094f5.pipedrive.com/pipeline" data-container="pipeline" data-tooltip="Deals">
					<span>
			...
			<li class="index-1 key-mailbox">
				<a href="https://callone-sandbox-9094f5.pipedrive.com/mail" data-container="mailbox" data-tooltip="E-Mail"><span class="infoBadge">
			...
			<li class="index-2 key-activities">
				<a href="https://callone-sandbox-9094f5.pipedrive.com/activities" data-container="activities" data-tooltip="Aktivitäten">
			...
			<li class="index-3 key-contacts"><a href="https://callone-sandbox-9094f5.pipedrive.com/person/1#" data-container="contacts" data-dropmenu="contacts" data-noactive="true" data-tooltip="Kontakte">
				<span>
			...
			<li class="index-4 key-statistics">
				<a href="https://callone-sandbox-9094f5.pipedrive.com/progress" data-container="statistics" data-dropmenu="statistics" data-noactive="true" data-tooltip="Analyse" class="">
...
<script type="text/html" id="dropMenu-profile">
	<ul class="headerDropMenu">
			...
			<li>
				<a data-tracking="userProfile_link" data-container="statistics" href="https://callone-sandbox-9094f5.pipedrive.com/users/details/2296758">
		...
		<li>
			...
			href="https://callone-sandbox-9094f5.pipedrive.com
			/settings/billing">
		...
		<li>
			<a data-tracking="invites_link" href="https://callone-sandbox-9094f5.pipedrive.com/settings/invites">
		...
		<li class="dropMenuSeparator"></li>
		<li>
			<a data-tracking="logout_link" href="https://callone-sandbox-9094f5.pipedrive.com/auth/logout">
...
<div data-quick-actions-app="true"></div></nav>
		...
		<div class="viewSelectContainer">
			<div class="calendarSwitch">
				<div class="cui4-button-group">
					<a class="cui4-button list cui4-button--active" id="pipeButton-MofjE31b" data-text="Liste" href="https://callone-sandbox-9094f5.pipedrive.com/activities/list">
			<svg class="cui4-icon cui4-icon--s"><use xlink:href="#icon-sm-list" href="#icon-sm-list"></use></svg>
			
			
			
		</a>
					<a class="cui4-button timelineButton calendarLinkIcon" id="pipeButton-yC84VX10" data-text="Kalender" href="https://callone-sandbox-9094f5.pipedrive.com/activities/calendar">
			...
			<div class="toolbarContainer">
				<a class="cui4-button addActivityButton cui4-button--green" id="activitiesAddActivity" data-test="addButton-button" href="https://callone-sandbox-9094f5.pipedrive.com/person/1#dialog/activity/add">
	...
	<span class="listSummaryIcon">
		...
		<div class="actionsAndFiltersContainer">
			...
			<div class="filterMenuContainer"><div class="changeFilter"><button class="cui4-button" data-test="filter-menu-button"><svg class="cui4-icon cui4-icon--s"><use href="#icon-sm-filter" xlink:href="#icon-sm-filter"></use></svg><span class="client-filters-menu-components-___styles__selectButtonName___2q1bo">CallOne</span><svg class="cui4-icon cui4-icon--s"><use href="#icon-sm-triangle-down" xlink:href="#icon-sm-triangle-down"></use></svg></button></div></div>
			
				<div class="additionalActions">
					<span class="input selectSettings">
		<a class="cui4-button" id="pipeButton-ujuGcB7m" data-test="selectSettings-button" href="https://callone-sandbox-9094f5.pipedrive.com/person/1#">
...
<div class="grid__ghostScrollbar" style="width: 0px;">
	...
	<div class="servicePage" style="height: 100%"><div class="csd-App"><div class="csd-Layout cui4-text" data-loading="false"><div class="csd-Header"><div class="csd-Header__title"><div class="cui4-button-group"><div class="csd-DashboardSelectContainer"><span class="csd-DashboardSelectContainer csd-DashboardSelectContainer__PopoverTrigger"><div class="csd-HeaderTitle"><div class="csd-HeaderTitleWrap" id="selectDashboard"><button class="cui4-button" title="Dashboard"><svg class="cui4-icon cui4-icon--s"><use href="#icon-sm-dashboard" xlink:href="#icon-sm-dashboard"></use></svg><span>Dashboard</span><svg class="cui4-icon cui4-icon--s"><use href="#icon-sm-triangle-down" xlink:href="#icon-sm-triangle-down"></use></svg></button></div></div></span></div><button class="cui4-button csd-EditButton" id="editDashboard"><svg class="cui4-icon cui4-icon--s"><use href="#icon-sm-pencil" xlink:href="#icon-sm-pencil"></use></svg></button></div><div class="csd-extraActionButtons"><button class="cui4-button fullscreenButton"><svg class="cui4-icon cui4-icon--s"><use href="#icon-sm-fullscreen" xlink:href="#icon-sm-fullscreen"></use></svg></button></div></div><div class="csd-Header__actionButtons"><div><div class="csd-ChangeTimePeriod"><button class="cui4-button csd-DashboardFilterButton"><svg class="cui4-icon cui4-icon--s"><use href="#icon-sm-calendar" xlink:href="#icon-sm-calendar"></use></svg><span>Diesen Monat</span><svg class="cui4-icon cui4-icon--s"><use href="#icon-sm-triangle-down" xlink:href="#icon-sm-triangle-down"></use></svg></button></div><button class="cui4-button csd-DashboardFilterButton"><svg class="cui4-icon cui4-icon--s"><use href="#icon-sm-pipeline" xlink:href="#icon-sm-pipeline"></use></svg><span>Pipeline</span><svg class="cui4-icon cui4-icon--s"><use href="#icon-sm-triangle-down" xlink:href="#icon-sm-triangle-down"></use></svg></button><button class="cui4-button" data-test="filter-menu-button"><svg class="cui4-icon cui4-icon--s"><use href="#icon-sm-filter" xlink:href="#icon-sm-filter"></use></svg><span class="client-filters-menu-components-___styles__selectButtonName___2q1bo">Alle</span><svg class="cui4-icon cui4-icon--s"><use href="#icon-sm-triangle-down" xlink:href="#icon-sm-triangle-down"></use></svg></button><div data-coachmark="iamcoachmark-filters-menu-container"></div></div></div></div><div class="cui4-message cui4-message--visible cui4-message--alternative csd-InsightsMsg" style="height: 0px;"><div class="cui4-message__inner"><div class="cui4-message__content-wrap"><div class="cui4-message__content"><span>Not quite what you need? Create a fully customizable dashboard in <a href="https://callone-sandbox-9094f5.pipedrive.com/progress/insights">Insights (beta)</a></span></div></div><button class="cui4-button cui4-button--ghost cui4-button--s cui4-message__close"><svg class="cui4-icon cui4-icon--black cui4-icon--s"><use href="#icon-sm-cross" xlink:href="#icon-sm-cross"></use></svg></button></div></div><div class="csd-Columns csd-Columns--withGoalsMessage"><div class="csd-Column"><div class="csd-Block csd-DealSummaryBlock"><div class="cui4-panel"><div class="cui4-spacing cui4-spacing--top-m cui4-spacing--right-m cui4-spacing--bottom-m cui4-spacing--left-m"><div class="csd-Block__Header csd-Block__Header--Clickable"><a class="cui4-Text" href="https://callone-sandbox-9094f5.pipedrive.com/progress/reports/deal/started/users/1/month/count/owner" draggable="false"><span><h3 class="cui4-Text">Gestartete Deals</h3></span><svg class="cui4-icon cui4-icon--black-24 cui4-icon--s" draggable="false"><use href="#icon-sm-arrow-right" xlink:href="#icon-sm-arrow-right"></use></svg></a><div class="AddGoalModalWrapper"><button class="cui4-button add-goal" data-test="add-goal-button"><svg class="cui4-icon cui4-icon--black cui4-icon--s"><use href="#icon-sm-plus" xlink:href="#icon-sm-plus"></use></svg><span>Ziel hinzufügen</span></button></div></div><div><div class="csd-BlockRow" data-size="large"><span class="csd-BlockRow__value" data-color="blue">0</span><div class="cui4-trend"><svg class="cui4-icon cui4-icon--black-32 cui4-icon--s cui4-trend__icon"><use href="#icon-sm-triangle-left" xlink:href="#icon-sm-triangle-left"></use></svg></div></div><div class="csd-BlockRow"><span class="csd-BlockRow__value">0&nbsp;€</span><div class="cui4-trend"><svg class="cui4-icon cui4-icon--black-32 cui4-icon--s cui4-trend__icon"><use href="#icon-sm-triangle-left" xlink:href="#icon-sm-triangle-left"></use></svg></div></div></div></div></div></div><div class="csd-Block csd-ActivitiesBlock"><div class="cui4-panel"><div class="cui4-spacing cui4-spacing--top-m cui4-spacing--right-m cui4-spacing--bottom-m cui4-spacing--left-m"><div class="csd-Block__Header csd-Block__Header--Clickable"><a class="cui4-Text" href="https://callone-sandbox-9094f5.pipedrive.com/progress/reports/activity/created/users/1/month" draggable="false"><span><h3 class="cui4-Text">Hinzugefügte Aktivitäten</h3></span><svg class="cui4-icon cui4-icon--black-24 cui4-icon--s" draggable="false"><use href="#icon-sm-arrow-right" xlink:href="#icon-sm-arrow-right"></use></svg></a><div class="AddGoalModalWrapper"><button class="cui4-button add-goal" data-test="add-goal-button"><svg class="cui4-icon cui4-icon--black cui4-icon--s"><use href="#icon-sm-plus" xlink:href="#icon-sm-plus"></use></svg><span>Ziel hinzufügen</span></button></div></div><div class="csd-Block__Error cui4-Text">Keine Daten für den ausgewählten Zeitraum gefunden.</div></div></div></div><div class="csd-Block csd-ActivitiesBlock"><div class="cui4-panel"><div class="cui4-spacing cui4-spacing--top-m cui4-spacing--right-m cui4-spacing--bottom-m cui4-spacing--left-m"><div class="csd-Block__Header csd-Block__Header--Clickable"><a class="cui4-Text" href="https://callone-sandbox-9094f5.pipedrive.com/progress/reports/activity/done/users/1/month" draggable="false"><span><h3 class="cui4-Text">Abgeschlossene Aktivitäten</h3></span><svg class="cui4-icon cui4-icon--black-24 cui4-icon--s" draggable="false"><use href="#icon-sm-arrow-right" xlink:href="#icon-sm-arrow-right"></use></svg></a><div class="AddGoalModalWrapper"><button class="cui4-button add-goal" data-test="add-goal-button"><svg class="cui4-icon cui4-icon--black cui4-icon--s"><use href="#icon-sm-plus" xlink:href="#icon-sm-plus"></use></svg><span>Ziel hinzufügen</span></button></div></div><div class="csd-Block__Error cui4-Text">Keine Daten für den ausgewählten Zeitraum gefunden.</div></div></div></div><div class="csd-Block csd-DealProgressStagesBlock"><div class="cui4-panel"><div class="cui4-spacing cui4-spacing--top-m cui4-spacing--right-m cui4-spacing--bottom-m cui4-spacing--left-m"><div class="csd-Block__Header csd-Block__Header--Clickable"><a class="cui4-Text" href="https://callone-sandbox-9094f5.pipedrive.com/progress/reports/deal/progress/stages/1/month/count/all" draggable="false"><span><h3 class="cui4-Text">Deals Fortschritt nach Anzahl</h3></span><svg class="cui4-icon cui4-icon--black-24 cui4-icon--s" draggable="false"><use href="#icon-sm-arrow-right" xlink:href="#icon-sm-arrow-right"></use></svg></a><div class="AddGoalModalWrapper"><button class="cui4-button add-goal" data-test="add-goal-button"><svg class="cui4-icon cui4-icon--black cui4-icon--s"><use href="#icon-sm-plus" xlink:href="#icon-sm-plus"></use></svg><span>Ziel hinzufügen</span></button></div></div><div class="csd-Block__Error cui4-Text">Keine Daten für den ausgewählten Zeitraum gefunden.</div></div></div></div></div><div class="csd-Column"><div class="csd-Block csd-DealSummaryBlock"><div class="cui4-panel"><div class="cui4-spacing cui4-spacing--top-m cui4-spacing--right-m cui4-spacing--bottom-m cui4-spacing--left-m"><div class="csd-Block__Header csd-Block__Header--Clickable"><a class="cui4-Text" href="https://callone-sandbox-9094f5.pipedrive.com/progress/reports/deal/lost/users/1/month/count" draggable="false"><span><h3 class="cui4-Text">Verlorene Deals</h3></span><svg class="cui4-icon cui4-icon--black-24 cui4-icon--s" draggable="false"><use href="#icon-sm-arrow-right" xlink:href="#icon-sm-arrow-right"></use></svg></a></div><div><div class="csd-BlockRow" data-size="large"><span class="csd-BlockRow__value" data-color="red">0</span><div class="cui4-trend"><svg class="cui4-icon cui4-icon--black-32 cui4-icon--s cui4-trend__icon"><use href="#icon-sm-triangle-left" xlink:href="#icon-sm-triangle-left"></use></svg></div></div><div class="csd-BlockRow"><span class="csd-BlockRow__value">0&nbsp;€</span><div class="cui4-trend"><svg class="cui4-icon cui4-icon--black-32 cui4-icon--s cui4-trend__icon"><use href="#icon-sm-triangle-left" xlink:href="#icon-sm-triangle-left"></use></svg></div></div></div></div></div></div><div class="csd-Block csd-EmailsBlock"><div class="cui4-panel"><div class="cui4-spacing cui4-spacing--top-m cui4-spacing--right-m cui4-spacing--bottom-m cui4-spacing--left-m"><div class="csd-Block__Header csd-Block__Header--Clickable"><a class="cui4-Text" href="https://callone-sandbox-9094f5.pipedrive.com/progress/reports/email/sent/users/1/month" draggable="false"><span><h3 class="cui4-Text">Gesendete E-Mails</h3></span><svg class="cui4-icon cui4-icon--black-24 cui4-icon--s" draggable="false"><use href="#icon-sm-arrow-right" xlink:href="#icon-sm-arrow-right"></use></svg></a></div><div><div class="csd-BlockRow"><span class="csd-BlockRow__value">0</span><div class="cui4-trend"><svg class="cui4-icon cui4-icon--black-32 cui4-icon--s cui4-trend__icon"><use href="#icon-sm-triangle-left" xlink:href="#icon-sm-triangle-left"></use></svg></div></div><div class="csd-BlockSeparator"><div class="csd-BlockSeparator__Content"><a class="expandButton" href="https://callone-sandbox-9094f5.pipedrive.com/person/1#" draggable="false">Details schließen</a></div></div><div class="details" data-open="true"><div class="csd-BlockRow" data-size="small"><span class="csd-BlockRow__value">0 Mit Kontakten verknüpft</span><div class="cui4-trend"><svg class="cui4-icon cui4-icon--black-32 cui4-icon--s cui4-trend__icon"><use href="#icon-sm-triangle-left" xlink:href="#icon-sm-triangle-left"></use></svg></div></div><div class="csd-BlockRow" data-size="small"><span class="csd-BlockRow__value">0 Mit Deals verknüpft</span><div class="cui4-trend"><svg class="cui4-icon cui4-icon--black-32 cui4-icon--s cui4-trend__icon"><use href="#icon-sm-triangle-left" xlink:href="#icon-sm-triangle-left"></use></svg></div></div><div class="csd-BlockRow" data-size="small"><span class="csd-BlockRow__value">0 Geteilt</span><div class="cui4-trend"><svg class="cui4-icon cui4-icon--black-32 cui4-icon--s cui4-trend__icon"><use href="#icon-sm-triangle-left" xlink:href="#icon-sm-triangle-left"></use></svg></div></div></div></div></div></div></div><div class="csd-Block csd-EmailsBlock"><div class="cui4-panel"><div class="cui4-spacing cui4-spacing--top-m cui4-spacing--right-m cui4-spacing--bottom-m cui4-spacing--left-m"><div class="csd-Block__Header csd-Block__Header--Clickable"><a class="cui4-Text" href="https://callone-sandbox-9094f5.pipedrive.com/progress/reports/email/received/users/1/month" draggable="false"><span><h3 class="cui4-Text">Erhaltene E-Mails</h3></span><svg class="cui4-icon cui4-icon--black-24 cui4-icon--s" draggable="false"><use href="#icon-sm-arrow-right" xlink:href="#icon-sm-arrow-right"></use></svg></a></div><div><div class="csd-BlockRow"><span class="csd-BlockRow__value">0</span><div class="cui4-trend"><svg class="cui4-icon cui4-icon--black-32 cui4-icon--s cui4-trend__icon"><use href="#icon-sm-triangle-left" xlink:href="#icon-sm-triangle-left"></use></svg></div></div><div class="csd-BlockSeparator"><div class="csd-BlockSeparator__Content"><a class="expandButton" href="https://callone-sandbox-9094f5.pipedrive.com/person/1#" draggable="false">Details schließen</a></div></div><div class="details" data-open="true"><div class="csd-BlockRow" data-size="small"><span class="csd-BlockRow__value">0 Mit Kontakten verknüpft</span><div class="cui4-trend"><svg class="cui4-icon cui4-icon--black-32 cui4-icon--s cui4-trend__icon"><use href="#icon-sm-triangle-left" xlink:href="#icon-sm-triangle-left"></use></svg></div></div><div class="csd-BlockRow" data-size="small"><span class="csd-BlockRow__value">0 Mit Deals verknüpft</span><div class="cui4-trend"><svg class="cui4-icon cui4-icon--black-32 cui4-icon--s cui4-trend__icon"><use href="#icon-sm-triangle-left" xlink:href="#icon-sm-triangle-left"></use></svg></div></div><div class="csd-BlockRow" data-size="small"><span class="csd-BlockRow__value">0 Geteilt</span><div class="cui4-trend"><svg class="cui4-icon cui4-icon--black-32 cui4-icon--s cui4-trend__icon"><use href="#icon-sm-triangle-left" xlink:href="#icon-sm-triangle-left"></use></svg></div></div></div></div></div></div></div><div class="csd-Block csd-DealSummaryUsersBlock"><div class="cui4-panel"><div class="cui4-spacing cui4-spacing--top-m cui4-spacing--right-m cui4-spacing--bottom-m cui4-spacing--left-m"><div class="csd-Block__Header csd-Block__Header--Clickable"><a class="cui4-Text" href="https://callone-sandbox-9094f5.pipedrive.com/progress/reports/deal/started/users/1/month/count/owner" draggable="false"><span><h3 class="cui4-Text">Meiste Deals gestartet von</h3></span><svg class="cui4-icon cui4-icon--black-24 cui4-icon--s" draggable="false"><use href="#icon-sm-arrow-right" xlink:href="#icon-sm-arrow-right"></use></svg></a></div><div class="csd-Block__Error cui4-Text">Keine Daten für den ausgewählten Zeitraum gefunden.</div></div></div></div><div class="csd-Block csd-DealProgressStagesBlock"><div class="cui4-panel"><div class="cui4-spacing cui4-spacing--top-m cui4-spacing--right-m cui4-spacing--bottom-m cui4-spacing--left-m"><div class="csd-Block__Header csd-Block__Header--Clickable"><a class="cui4-Text" href="https://callone-sandbox-9094f5.pipedrive.com/progress/reports/deal/progress/stages/1/month/value/all" draggable="false"><span><h3 class="cui4-Text">Deals Fortschritt nach Wert</h3></span><svg class="cui4-icon cui4-icon--black-24 cui4-icon--s" draggable="false"><use href="#icon-sm-arrow-right" xlink:href="#icon-sm-arrow-right"></use></svg></a><div class="AddGoalModalWrapper"><button class="cui4-button add-goal" data-test="add-goal-button"><svg class="cui4-icon cui4-icon--black cui4-icon--s"><use href="#icon-sm-plus" xlink:href="#icon-sm-plus"></use></svg><span>Ziel hinzufügen</span></button></div></div><div class="csd-Block__Error cui4-Text">Keine Daten für den ausgewählten Zeitraum gefunden.</div></div></div></div></div><div class="csd-Column"><div class="csd-Block csd-DealSummaryBlock"><div class="cui4-panel"><div class="cui4-spacing cui4-spacing--top-m cui4-spacing--right-m cui4-spacing--bottom-m cui4-spacing--left-m"><div class="csd-Block__Header csd-Block__Header--Clickable"><a class="cui4-Text" href="https://callone-sandbox-9094f5.pipedrive.com/progress/reports/deal/won/users/1/month/count" draggable="false"><span><h3 class="cui4-Text">Gewonnene Deals</h3></span><svg class="cui4-icon cui4-icon--black-24 cui4-icon--s" draggable="false"><use href="#icon-sm-arrow-right" xlink:href="#icon-sm-arrow-right"></use></svg></a><div class="AddGoalModalWrapper"><button class="cui4-button add-goal" data-test="add-goal-button"><svg class="cui4-icon cui4-icon--black cui4-icon--s"><use href="#icon-sm-plus" xlink:href="#icon-sm-plus"></use></svg><span>Ziel hinzufügen</span></button></div></div><div><div class="csd-BlockRow" data-size="large"><span class="csd-BlockRow__value" data-color="green">0</span><div class="cui4-trend"><svg class="cui4-icon cui4-icon--black-32 cui4-icon--s cui4-trend__icon"><use href="#icon-sm-triangle-left" xlink:href="#icon-sm-triangle-left"></use></svg></div></div><div class="csd-BlockRow"><span class="csd-BlockRow__value">0&nbsp;€</span><div class="cui4-trend"><svg class="cui4-icon cui4-icon--black-32 cui4-icon--s cui4-trend__icon"><use href="#icon-sm-triangle-left" xlink:href="#icon-sm-triangle-left"></use></svg></div></div></div></div></div></div><div class="csd-Block csd-DealSummaryUsersBlock"><div class="cui4-panel"><div class="cui4-spacing cui4-spacing--top-m cui4-spacing--right-m cui4-spacing--bottom-m cui4-spacing--left-m"><div class="csd-Block__Header csd-Block__Header--Clickable"><a class="cui4-Text" href="https://callone-sandbox-9094f5.pipedrive.com/progress/reports/deal/won/users/1/month/count" draggable="false"><span><h3 class="cui4-Text">Meiste Deals gewonnen von</h3></span><svg class="cui4-icon cui4-icon--black-24 cui4-icon--s" draggable="false"><use href="#icon-sm-arrow-right" xlink:href="#icon-sm-arrow-right"></use></svg></a></div><div class="csd-Block__Error cui4-Text">Keine Daten für den ausgewählten Zeitraum gefunden.</div></div></div></div><div class="csd-Block csd-RevenueForecastBlock csd-RevenueForecastBlock__Teaser"><div class="cui4-panel"><div class="cui4-spacing cui4-spacing--top-m cui4-spacing--right-m cui4-spacing--bottom-m cui4-spacing--left-m"><div class="csd-Block__Header csd-Block__Header--Clickable"><a class="cui4-Text" href="https://callone-sandbox-9094f5.pipedrive.com/progress/reports/revenue/forecast/deals/1/month/weeks/all" draggable="false"><span><h3 class="cui4-Text">Kumulative Umsatzprognose</h3></span><svg class="cui4-icon cui4-icon--black-24 cui4-icon--s" draggable="false"><use href="#icon-sm-arrow-right" xlink:href="#icon-sm-arrow-right"></use></svg></a></div><section class="csd-RevenueForecastTeaser"><div class="content">Das große Ganze: visualisieren Sie Ihre zukünftigen Ergebnisse, passen Sie Ihren Kurs an und erreichen Sie Ihre Ziele.</div><div class="actions"><a class="action-item" href="https://callone-sandbox-9094f5.pipedrive.com/person/1#">Verwerfen</a><a class="action-item" href="https://callone-sandbox-9094f5.pipedrive.com/progress/reports/revenue/forecast/teaser">Mehr erfahren</a></div></section></div></div></div><div class="csd-Block csd-PhoneCallsBlock"><div class="cui4-panel"><div class="cui4-spacing cui4-spacing--top-m cui4-spacing--right-m cui4-spacing--bottom-m cui4-spacing--left-m"><div class="csd-Block__Header"><h3 class="cui4-Text">Calling insights</h3></div><div class="csd-Block__Error cui4-Text">Keine Daten für den ausgewählten Zeitraum gefunden.</div></div></div></div></div></div></div></div></div>
	...
	<div class="detailView personDetails">
		...
		<a class="link" href="https://callone-sandbox-9094f5.pipedrive.com/users/details/2296758">
			<div class="image" style="background-image: url(&#39;https://d3myhnqlqw2314.cloudfront.net/profile_120x120_2296758_f50241dab5b46a186fada0e886d2f5d1.jpg&#39;);"></div>
			<div class="info">
				<span class="name">CallOne</span>
				<span class="role">Besitzer</span>
			</div>
		</a>
	
	<span class="input transferOwner">
		<a class="cui4-button cui4-button--ghost cui4-button--s" id="pipeButton-GMZuqffj" data-test="transferOwner-button" href="https://callone-sandbox-9094f5.pipedrive.com/person/1#">
...
<div data-state="read" class="widget personFields fieldsView"><div class="columnTitle"><span class="columnItem">Details</span><div class="columnActions"><button class="cui4-button editAll cui4-button--s" id="pipeButton-H2sMPSZd" data-test="edit-all" data-tooltip="Edit all fields">
	...
	phoneField editable
	"><div class="labelWrap clearfix"><span class="label">Telefon<div><div class="cui4-text"></div></div></span></div><div><div class="valueWrap singleRow clearfix phoneGroup salesPhone"><span class="phoneNumber"><span class="value"><a href="https://connect.callone.io/crms/pipedrive/callone_presentation_e4f0fb63de8c3c0fbb2bd4e602045947/action.php?crm_user_id=2296758&amp;destination=00491734709719" data-test="phone-label">00491734709719</a></span><span class="valueRemark"><span class="label"></span></span></span><button class="salesPhoneOptions"><svg class="cui4-icon cui4-icon--blue cui4-icon--s"><use xlink:href="#icon-sm-arrow-down" href="#icon-sm-arrow-down"></use></svg></button></div></div><span class="input buttonEdit action edit" title="Bearbeiten">
	...
	<div class="linkObject">
		...
		<a class="cui4-text" href="https://callone-sandbox-9094f5.pipedrive.com/person/1#">+ Eine Organisation verknüpfen</a>
	</div>
	...
	<div class="columnTitle">
		...
		<div class="columnActions">
			<a class="cui4-button selectSettingsButton addNew cui4-button--s" id="pipeButton-zrquNLlh" data-type="deals" href="https://callone-sandbox-9094f5.pipedrive.com/person/1#">
	...
	<div class="addObject">
		...
		<a href="https://callone-sandbox-9094f5.pipedrive.com/person/1#" class="cui4-text addNew" data-type="deal">+ Neuen Deal hinzufügen</a>
	</div>
...
<ul>
	...
	<li>Erstellt <span>26. Juli 2019</span></li>
		...
		<span class="columnItem">Follower (1)</span>
	
	
		<div class="columnActions">
			<a class="cui4-button selectSettingsButton addNew cui4-button--s" id="pipeButton-PQnhEUHD" data-type="followers" data-tooltip="Einstellungen" href="https://callone-sandbox-9094f5.pipedrive.com/person/1#">
			<svg class="cui4-icon cui4-icon--s"><use xlink:href="#icon-sm-plus" href="#icon-sm-plus"></use></svg>
	...
	<a href="https://callone-sandbox-9094f5.pipedrive.com/users/details/2296758">
		CallOne
...
<ul class="headers">
		...
		<li style="" class="hasIcon active">
			<a href="https://callone-sandbox-9094f5.pipedrive.com/person/1#" data-target="note" data-test="">
		...
		<li style="" class="hasIcon">
			<a href="https://callone-sandbox-9094f5.pipedrive.com/person/1#" data-target="activity" data-test="add-activity-tab">
	...
	Zeit vorschlagen
		...
		<li style="" class="hasIcon">
			<a href="https://callone-sandbox-9094f5.pipedrive.com/person/1#" data-target="email" data-test="send-email-tab">
		...
		<li style="" class="hasIcon">
			<a href="https://callone-sandbox-9094f5.pipedrive.com/person/1#" data-target="file" data-test="">
...
<div class="content">
	...
	<div class="richTextArea">
		...
		<div class="editorToolbar">
			<div class="buttons">
				<a href="https://callone-sandbox-9094f5.pipedrive.com/person/1" class="toolbar_bold editor-tooltip" data-editor-tooltip="Fett (Ctrl B)"><svg class="cui4-icon"><use xlink:href="#icon-bold" href="#icon-bold"></use></svg></a>
				<a href="https://callone-sandbox-9094f5.pipedrive.com/person/1" class="toolbar_italic editor-tooltip" data-editor-tooltip="Kursiv (Ctrl I)"><svg class="cui4-icon"><use xlink:href="#icon-italic" href="#icon-italic"></use></svg></a>
				<a href="https://callone-sandbox-9094f5.pipedrive.com/person/1" class="toolbar_underline editor-tooltip" data-editor-tooltip="Unterstreichen (Ctrl U)"><svg class="cui4-icon"><use xlink:href="#icon-underline" href="#icon-underline"></use></svg></a>
				<a href="https://callone-sandbox-9094f5.pipedrive.com/person/1" class="toolbar_link editor-tooltip" data-editor-tooltip="Verknüpfen (Ctrl K)"><svg class="cui4-icon"><use xlink:href="#icon-link" href="#icon-link"></use></svg></a>
				
			</div>

			<div class="buttons">
				<a href="https://callone-sandbox-9094f5.pipedrive.com/person/1" class="toolbar_ul editor-tooltip" data-editor-tooltip="Ungeordnete Liste (Ctrl⇧8)"><svg class="cui4-icon"><use xlink:href="#icon-list-bulleted" href="#icon-list-bulleted"></use></svg></a>
				<a href="https://callone-sandbox-9094f5.pipedrive.com/person/1" class="toolbar_ol editor-tooltip" data-editor-tooltip="Geordnete Liste (Ctrl⇧7)"><svg class="cui4-icon"><use xlink:href="#icon-list-numbered" href="#icon-list-numbered"></use></svg></a>
			</div>

			<div class="buttons">
				<a href="https://callone-sandbox-9094f5.pipedrive.com/person/1" class="toolbar_remove editor-tooltip" data-editor-tooltip="Stil entfernen (Ctrl \)"><svg class="cui4-icon"><use xlink:href="#icon-clearformat" href="#icon-clearformat"></use></svg></a>
			</div>
			<div class="actions">
				<span class="input">
...
<div class="agenda__nav">
	<div class="cui4-button-group">
		<a class="cui4-button previous cui4-button--s" id="pipeButton-6YSDp4lD" data-title="Voriger Tag" href="https://callone-sandbox-9094f5.pipedrive.com/person/1#">
			<svg class="cui4-icon cui4-icon--s"><use xlink:href="#icon-sm-arrow-left" href="#icon-sm-arrow-left"></use></svg>
			
			
			
		</a>
		<a class="cui4-button next cui4-button--s" id="pipeButton-Jja71V57" data-title="Nächster Tag" href="https://callone-sandbox-9094f5.pipedrive.com/person/1#">
	...
	<span class="spinner"></span>
		...
		<div class="activityInvites__language">
			<div class="inviteLanguage__label" style="display: none;">
				...
				<span>·</span>
				<a href="https://callone-sandbox-9094f5.pipedrive.com/person/1" class="inviteLanguage__changeBtn">Ändern</a>
			</div>
...
<div class="activityEditor__spinnerContainer">
		...
		<section class="promo__upgrade">
			<div class="row">
				...
				<div class="link-container">
					<a class="learn-more track-analytics" href="https://callone-sandbox-9094f5.pipedrive.com/person/1" target="_blank" data-analytics="learn-more">
	...
	<div class="attachmentComponent">
			...
			<div class="empty">
				Dateien hierher ziehen oder <a href="https://callone-sandbox-9094f5.pipedrive.com/person/1#" class="attachFile"> von Ihrem Computer auswählen </a>
		...
		<a href="https://callone-sandbox-9094f5.pipedrive.com/person/1#" class="cui4-button cui4-button--ghost closeBtn" data-tooltip="Schließen"><svg class="cui4-icon cui4-icon--s"><use xlink:href="#icon-cross" href="#icon-cross"></use></svg></a>
...
<div class="flowItems">
	...
	<div class="flowItemDetails">
		...
		<span class="separator">·</span><span class="author">CallOne</span>
	</div>
...
<div id="bottomAd" style="position: absolute; top: -1000px; left: -1000px; width: 1px; height: 1px;"></div><div class="globalNotificationsContainer"></div><div id="global-search-results"><ul class="search-filters"><li class="search-filters__filter">
	<a href="https://callone-sandbox-9094f5.pipedrive.com/person/1#" class="search-filters__button search-filters__button--text active" data-filter="">
		Alle
	</a>
</li>
<li class="search-filters__filter">
	<a href="https://callone-sandbox-9094f5.pipedrive.com/person/1#" class="search-filters__button" data-filter="deal" data-tooltip="Deals">
		<svg class="cui4-icon cui4-icon--s"><use xlink:href="#icon-sm-deal" href="#icon-sm-deal"></use></svg>
	</a>
</li>
<li class="search-filters__filter">
	<a href="https://callone-sandbox-9094f5.pipedrive.com/person/1#" class="search-filters__button" data-filter="person" data-tooltip="Kontakte">
		<svg class="cui4-icon cui4-icon--s"><use xlink:href="#icon-sm-person" href="#icon-sm-person"></use></svg>
	</a>
</li>
<li class="search-filters__filter">
	<a href="https://callone-sandbox-9094f5.pipedrive.com/person/1#" class="search-filters__button" data-filter="organization" data-tooltip="Organisationen">
		<svg class="cui4-icon cui4-icon--s"><use xlink:href="#icon-sm-organization" href="#icon-sm-organization"></use></svg>
	</a>
</li>

<li class="search-filters__filter">
	<a href="https://callone-sandbox-9094f5.pipedrive.com/person/1#" class="search-filters__button" data-filter="file" data-tooltip="Dateien">
		<svg class="cui4-icon cui4-icon--s"><use xlink:href="#icon-sm-file" href="#icon-sm-file"></use></svg>
	</a>

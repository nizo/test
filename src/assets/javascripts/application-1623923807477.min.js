...
class Modal{constructor(t){this.button=t,this.modalname=t.dataset.callonemodal,this.modal=this.createModal(),this.getModalContent()}createModal(){let t=document.createElement("div");return t.classList.add("callone-modal"),t.classList.add("callone-modal--open"),document.body.appendChild(t),t.addEventListener("click",(t=>{this.modal==t.target&&this.closeModal()}).bind(this)),t}closeModal(){this.modal.classList.remove("callone-modal--open"),this.modal.remove()}getModalContent(){const t=new XMLHttpRequest;t.onreadystatechange=function(){t.readyState!=XMLHttpRequest.DONE&&200==t.status||(this.modal.innerHTML=t.responseText)}.bind(this),t.open("GET","/partials/modals/"+this.modalname+".html",!0),t.send()}}let modalButtons=document.querySelectorAll("[data-callonemodal]");modalButtons.forEach(t=>{t.addEventListener("click",e=>{new Modal(t)})});

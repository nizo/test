...
*/
class Range{constructor(t){this.ns="callone-range",this.slider=t,this.step=100/(this.slider.max/this.slider.step),this.dragging=!1,this.wrapper=document.createElement("div"),this.track=document.createElement("div"),this.thumb=document.createElement("div"),this.active=document.createElement("div"),this.output=null,this.slider.hasAttribute("data-output")&&(this.output=document.querySelector(this.slider.dataset.output)),this.output&&(this.setOutputValue(),this.slider.addEventListener("change",this.setOutputValue.bind(this)),this.output.addEventListener("keyup",this.setProgress.bind(this))),this.slider.hasAttribute("data-width")&&(this.wrapper.style.width=this.slider.dataset.width+"px"),this.slider.hasAttribute("data-height")&&(this.wrapper.style.height=this.slider.dataset.height+"px"),this.wrap(),this.addTrack(),this.addThumb(),this.addActive(),this.wrapper.addEventListener("click",this.changeProgress.bind(this)),this.thumb.addEventListener("mousedown",(()=>{this.dragging=!0}).bind(this)),window.addEventListener("mouseup",(()=>{this.dragging=!1}).bind(this)),window.addEventListener("mousemove",(t=>{this.dragging&&this.changeProgress(t)}).bind(this))}setOutputValue(){this.output.value=this.slider.value}setProgress(){let t=parseInt(this.output.value);t||(t=0),t<this.slider.min&&(t=this.slider.min),t>this.slider.max&&(t=this.slider.max),this.output.value=t;let e=100/this.slider.max*t;this.thumb.style.left=e+"%",this.active.style.width=e+"%",this.slider.value=this.slider.max*(e/100)}changeProgress(t){let e=this.wrapper.getBoundingClientRect(),s=t.pageX,i=(t.pageY,100/e.width*(s-e.x));i-=i%this.step,i<0&&(i=0),i>100&&(i=100),this.thumb.style.left=i+"%",this.active.style.width=i+"%",this.slider.value=this.slider.max*(i/100);let h=new Event("change");this.slider.dispatchEvent(h)}wrap(){this.wrapper.classList.add(this.ns),this.slider.parentNode.insertBefore(this.wrapper,this.slider),this.wrapper.appendChild(this.slider)}addTrack(){this.track.classList.add(this.ns+"__track"),this.wrapper.appendChild(this.track)}addThumb(){this.thumb.classList.add(this.ns+"__thumb"),this.thumb.style.left=this.getProgressInPercent()+"%",this.wrapper.appendChild(this.thumb)}addActive(){this.active.classList.add(this.ns+"__active"),this.active.style.width=this.getProgressInPercent()+"%",this.wrapper.appendChild(this.active)}getProgressInPercent(){return 100/this.slider.max*this.slider.value}}let sliders=document.querySelectorAll("[calloneRange]");sliders.forEach(t=>{new Range(t)});

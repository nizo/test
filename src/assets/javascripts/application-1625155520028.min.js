...
class Modal{constructor(t){this.namespace="callone-modal",this.button=t,this.modal=null,this.steps=null,this.activeStep=null,this.currentStep=1,this.modalContent=null,this.closeButton=null,this.button.addEventListener("click",this.openModal.bind(this)),this.loadModalContent()}loadModalContent(){this.modal=document.querySelector('[data-modal="'+this.button.dataset.openmodal+'"]'),this.modal?this.initModal():this.modal=this.getModalContent(this.button.dataset.openmodal)}initModal(){this.steps=this.modal.querySelectorAll("."+this.namespace+"__step");let t=document.createElement("div");t.classList.add(this.namespace+"__wrapper");let e=document.createElement("div");e.classList.add(this.namespace+"__header"),t.appendChild(e),this.closeButton=document.createElement("div"),this.closeButton.classList.add(this.namespace+"__headerbutton"),this.closeButton.classList.add(this.namespace+"__headerbutton--close"),this.closeButton.textContent=this.modal.dataset.canceltext||"Schließen",this.closeButton.addEventListener("click",this.closeModal.bind(this)),e.appendChild(this.closeButton);let s=document.createElement("div");if(s.classList.add(this.namespace+"__title"),this.steps.length>0){this.activeStep=this.getActiveStep();let t=document.createElement("div");t.classList.add(this.namespace+"__steptitle"),this.activeStep.dataset.steptitle&&""!==this.activeStep.dataset.steptitle?t.textContent=this.activeStep.dataset.steptitle:t.textContent="Schritt "+(this.activeStep.dataset.stepIndicator||this.activeStep.dataset.stepId),s.appendChild(t);let a=document.createElement("div");if(a.classList.add(this.namespace+"__step-indicators"),this.activeStep.dataset.stepIndicator){let t=this.activeStep.dataset.stepIndicator.split("/"),e=parseInt(t[0]),s=parseInt(t[1]);for(let t=1;t<=s;t++){let s=document.createElement("div");s.classList.add(this.namespace+"__step-indicator"),t==e&&s.classList.add(this.namespace+"__step-indicator--active"),a.appendChild(s)}}s.appendChild(a),this.activeStep.classList.add(this.namespace+"__step--active");let i=document.createElement("div");i.classList.add(this.namespace+"__headerbutton"),i.classList.add(this.namespace+"__headerbutton--back"),i.classList.add(this.namespace+"__headerbutton--hidden"),i.textContent="Schritt zurück",i.addEventListener("click",this.prevStep.bind(this)),e.appendChild(i)}else{s.innerHTML=this.modal.dataset.title;let t=document.createElement("span");t.textContent=this.modal.dataset.subtitle,s.appendChild(t)}e.appendChild(s),this.modalContent=document.createElement("div"),this.modalContent.classList.add(this.namespace+"__content"),this.modalContent.innerHTML=this.modal.innerHTML;let a=this.modalContent.querySelectorAll("."+this.namespace+"__nextstep");a.length>0&&a.forEach(t=>{t.addEventListener("click",this.nextStep.bind(this))});let i=this.modalContent.querySelectorAll("."+this.namespace+"__submit");i.length>0&&i.forEach(t=>{t.addEventListener("click",this.submitStep.bind(this))}),t.appendChild(this.modalContent),this.modal.innerHTML="",this.modal.appendChild(t),this.modal.addEventListener("mousedown",(t=>{this.modal==t.target&&this.closeModal()}).bind(this))}submitStep(t){t.preventDefault(),"function"==typeof window[t.target.dataset.stepCallback]&&window[t.target.dataset.stepCallback](t,this.nextStep.bind(this,t))}nextStep(t){t.preventDefault(),this.currentStep=parseInt(t.target.dataset.nextStep),this.switchStep()}prevStep(){this.currentStep=parseInt(this.activeStep.dataset.prevStep),this.switchStep()}getActiveStep(){let t=null;return this.steps=this.modal.querySelectorAll("."+this.namespace+"__step"),this.steps.forEach(e=>{e.hasAttribute("data-step-id")&&parseInt(e.getAttribute("data-step-id"))===this.currentStep&&(t=e)}),t}switchStep(){this.activeStep=this.getActiveStep();let t=this.modal.querySelector("."+this.namespace+"__steptitle"),e=this.modal.querySelector("."+this.namespace+"__step-indicators"),s=this.modal.querySelector("."+this.namespace+"__headerbutton--back");if(this.closeButton.textContent=this.activeStep.dataset.canceltext||this.modal.dataset.canceltext||"Schließen",e.innerHTML="",this.activeStep.dataset.stepIndicator){let t=this.activeStep.dataset.stepIndicator.split("/"),s=parseInt(t[0]),a=parseInt(t[1]);for(let t=1;t<=a;t++){let a=document.createElement("div");a.classList.add(this.namespace+"__step-indicator"),t==s&&a.classList.add(this.namespace+"__step-indicator--active"),t<s&&a.classList.add(this.namespace+"__step-indicator--past"),e.appendChild(a)}}if(this.activeStep.dataset.stepNoscroll&&"true"===this.activeStep.dataset.stepNoscroll){this.modalContent.classList.add(this.namespace+"__content--scrolllock");let t=this.activeStep.querySelector(".calendly-inline-widget");t.style.height=this.modalContent.offsetHeight+"px";let e=window.getComputedStyle(this.modalContent,null),s={top:parseInt(e.getPropertyValue("padding-top")),right:parseInt(e.getPropertyValue("padding-right")),bottom:parseInt(e.getPropertyValue("padding-bottom")),left:parseInt(e.getPropertyValue("padding-left"))};t.style.marginTop=-s.top+"px",t.style.marginRight=-s.right+"px",t.style.marginBottom=-s.bottom+"px",t.style.marginLeft=-s.left+"px"}else this.modalContent.classList.remove(this.namespace+"__content--scrolllock");this.steps.forEach(t=>t.classList.remove(this.namespace+"__step--active")),this.activeStep.classList.add(this.namespace+"__step--active"),this.activeStep.dataset.steptitle&&""!=this.activeStep.dataset.steptitle?t.textContent=this.activeStep.dataset.steptitle:t.textContent="Schritt "+(this.activeStep.dataset.stepIndicator||this.activeStep.dataset.stepId),this.currentStep>1?s.classList.remove(this.namespace+"__headerbutton--hidden"):s.classList.add(this.namespace+"__headerbutton--hidden")}runScripts(){let scripts=this.modal.querySelectorAll("script");scripts.forEach(script=>{if(script.hasAttribute("src")){let t=document.createElement("script");t.setAttribute("src",script.getAttribute("src")),script.parentNode.insertBefore(t,script),script.remove()}eval(script.textContent)})}openModal(t){t.preventDefault(),document.body.classList.add("callone-modal--scrolllock"),this.runScripts(),$(this.modal).css("display","flex").hide().fadeIn(300),this.modal.classList.add(this.namespace+"--open")}closeModal(){$(this.modal).fadeOut(300,function(){document.body.classList.remove("callone-modal--scrolllock"),this.modal.classList.remove(this.namespace+"--open"),this.currentStep=1,this.switchStep()}.bind(this))}getModalContent(t){const e=new XMLHttpRequest;e.onreadystatechange=function(){if(e.readyState===XMLHttpRequest.DONE&&200==e.status){let t=e.response,s=document.createElement("div");s.innerHTML=t,this.modal=s.querySelector(".callone-modal"),this.button.parentNode.insertBefore(this.modal,this.button.nextSibling),this.initModal()}}.bind(this),e.open("GET","/partials/modals/"+t+".php",!0),e.overrideMimeType("application/xml; charset=UTF-8"),e.send()}}let modalButtons=document.querySelectorAll("[data-openmodal]");modalButtons.forEach(t=>{new Modal(t)});

...
class Modal{constructor(t){this.namespace="callone-modal",this.button=t,this.modal=null,this.steps=null,this.currentStep=0,this.modalContent=null,this.button.addEventListener("click",this.openModal.bind(this)),this.loadModalContent()}loadModalContent(){this.modal=document.querySelector('[data-modal="'+this.button.dataset.openmodal+'"]'),this.modal?this.initModal():this.modal=this.getModalContent(this.button.dataset.openmodal)}initModal(){this.steps=this.modal.querySelectorAll("."+this.namespace+"__step");let t=document.createElement("div");t.classList.add(this.namespace+"__wrapper");let e=document.createElement("div");e.classList.add(this.namespace+"__header"),t.appendChild(e);let s=document.createElement("div");s.classList.add(this.namespace+"__headerbutton"),s.classList.add(this.namespace+"__headerbutton--close"),s.textContent=this.modal.dataset.canceltext||"Schließen",s.addEventListener("click",this.closeModal.bind(this)),e.appendChild(s);let a=document.createElement("div");if(a.classList.add(this.namespace+"__title"),this.steps.length>0){let t=document.createElement("div");t.classList.add(this.namespace+"__steptitle"),this.steps[0].dataset.steptitle&&""!=this.steps[0].dataset.steptitle?t.textContent=this.steps[0].dataset.steptitle:t.textContent="Schritt 1/"+this.steps.length,a.appendChild(t);let s=document.createElement("div");s.classList.add(this.namespace+"__steps");for(let t=0;t<this.steps.length;t++){let e=document.createElement("div");e.classList.add(this.namespace+"__stepindicator"),t==this.currentStep&&e.classList.add(this.namespace+"__stepindicator--active"),s.appendChild(e)}a.appendChild(s),this.steps[this.currentStep].classList.add(this.namespace+"__step--active");let i=document.createElement("div");i.classList.add(this.namespace+"__headerbutton"),i.classList.add(this.namespace+"__headerbutton--back"),i.classList.add(this.namespace+"__headerbutton--hidden"),i.textContent="Schritt zurück",i.addEventListener("click",this.prevStep.bind(this)),e.appendChild(i)}else{a.innerHTML=this.modal.dataset.title;let t=document.createElement("span");t.textContent=this.modal.dataset.subtitle,a.appendChild(t)}e.appendChild(a);let i=document.createElement("div");i.classList.add(this.namespace+"__content"),i.innerHTML=this.modal.innerHTML;let n=i.querySelectorAll("."+this.namespace+"__nextstep");n.length>0&&n.forEach(t=>{t.addEventListener("click",this.nextStep.bind(this))}),t.appendChild(i),this.modal.innerHTML="",this.modal.appendChild(t),this.modal.addEventListener("click",(t=>{this.modal==t.target&&this.closeModal()}).bind(this))}nextStep(t){t.preventDefault(),this.currentStep++,this.switchStep()}prevStep(){this.currentStep--,this.switchStep()}switchStep(){if(this.currentStep>=0&&this.currentStep<this.steps.length){let t=this.modal.querySelectorAll("."+this.namespace+"__step"),e=this.modal.querySelector("."+this.namespace+"__steptitle"),s=this.modal.querySelectorAll("."+this.namespace+"__stepindicator"),a=this.modal.querySelector("."+this.namespace+"__headerbutton--back");s.forEach((t,e)=>{t.classList.remove(this.namespace+"__stepindicator--past"),e<this.currentStep&&t.classList.add(this.namespace+"__stepindicator--past"),t.classList.remove(this.namespace+"__stepindicator--active")}),s[this.currentStep].classList.add(this.namespace+"__stepindicator--active"),t.forEach(t=>t.classList.remove(this.namespace+"__step--active")),t[this.currentStep].classList.add(this.namespace+"__step--active"),t[this.currentStep].dataset.steptitle&&""!=t[this.currentStep].dataset.steptitle?e.textContent=t[this.currentStep].dataset.steptitle:e.textContent="Schritt "+(parseInt(this.currentStep)+1)+"/"+this.steps.length,this.currentStep>0?a.classList.remove(this.namespace+"__headerbutton--hidden"):a.classList.add(this.namespace+"__headerbutton--hidden"),this.runScripts()}}runScripts(){let scripts=this.modal.querySelectorAll("script");scripts.forEach(script=>{eval(script.textContent)})}openModal(t){t.preventDefault(),document.body.classList.add("callone-modal--scrolllock"),this.runScripts(),this.modal.classList.add(this.namespace+"--open")}closeModal(){document.body.classList.remove("callone-modal--scrolllock"),this.modal.classList.remove(this.namespace+"--open"),this.currentStep=0,this.switchStep()}getModalContent(t){const e=new XMLHttpRequest;e.onreadystatechange=function(){if(e.readyState===XMLHttpRequest.DONE&&200==e.status){let t=e.response;this.modal=t.querySelector(".callone-modal"),this.button.parentNode.insertBefore(this.modal,this.button.nextSibling),this.initModal()}}.bind(this),e.responseType="document",e.open("GET","/partials/modals/"+t+".html",!0),e.send()}}let modalButtons=document.querySelectorAll("[data-openmodal]");modalButtons.forEach(t=>{new Modal(t)});
 ...
 */
class Range{constructor(t){this.classNamespace="callone-range",this.slider=t,this.slider.dataset.initialized&&"true"==this.slider.dataset.initialized||(this.slider.dataset.initialized="true",this.step=100/(this.slider.max/this.slider.step),this.dragging=!1,this.wrapper=document.createElement("div"),this.track=document.createElement("div"),this.thumb=document.createElement("div"),this.active=document.createElement("div"),this.output=null,this.slider.hasAttribute("data-output")&&(this.output=document.querySelector(this.slider.dataset.output)),this.output&&(this.setOutputValue(),this.slider.addEventListener("change",this.setOutputValue.bind(this)),this.output.addEventListener("keyup",this.setProgress.bind(this))),this.slider.hasAttribute("data-width")&&(this.wrapper.style.width=this.slider.dataset.width+"px"),this.slider.hasAttribute("data-height")&&(this.wrapper.style.height=this.slider.dataset.height+"px"),this.wrap(),this.addTrack(),this.addThumb(),this.addActive(),this.wrapper.addEventListener("click",this.changeProgress.bind(this)),this.wrapper.addEventListener("mousedown",(()=>{this.dragging=!0}).bind(this)),window.addEventListener("mouseup",(()=>{this.dragging=!1}).bind(this)),window.addEventListener("mousemove",(t=>{this.dragging&&this.changeProgress(t)}).bind(this)),this.thumb.addEventListener("touchstart",(()=>{this.dragging=!0}).bind(this)),window.addEventListener("touchend",(()=>{this.dragging=!1}).bind(this)),window.addEventListener("touchmove",(t=>{this.dragging&&this.changeProgress(t)}).bind(this)))}setOutputValue(){this.output.value=this.slider.value}setProgress(t){let e=t.which||t.keyCode,i=parseInt(this.output.value);38==e&&i++,40==e&&i--;let s=parseInt(this.slider.min),a=parseInt(this.slider.max);i||(i=0),i<s&&(i=s),i>a&&(i=a),this.output.value=i;let h=100/(a-s)*(i-s);this.thumb.style.left=h+"%",this.active.style.width=h+"%",this.slider.value=i;let d=new Event("change");this.slider.dispatchEvent(d)}changeProgress(t){let e=this.wrapper.getBoundingClientRect(),i={x:t.pageX,y:t.pageY};if("touchmove"==t.type){var s=void 0===t.originalEvent?t:t.originalEvent;let e=s.touches[0]||s.changedTouches[0];i.x=e.pageX,i.y=e.pageY}let a=100/e.width*(i.x-e.x);a-=a%this.step,a<0&&(a=0),a>100&&(a=100),this.thumb.style.left=a+"%",this.active.style.width=a+"%",this.slider.value=this.slider.max*(a/100);let h=new Event("change");this.slider.dispatchEvent(h)}wrap(){this.wrapper.classList.add(this.classNamespace),this.slider.parentNode.insertBefore(this.wrapper,this.slider),this.wrapper.appendChild(this.slider)}addTrack(){this.track.classList.add(this.classNamespace+"__track"),this.wrapper.appendChild(this.track)}addThumb(){this.thumb.classList.add(this.classNamespace+"__thumb"),this.thumb.style.left=this.getProgressInPercent()+"%",this.wrapper.appendChild(this.thumb)}addActive(){this.active.classList.add(this.classNamespace+"__active"),this.active.style.width=this.getProgressInPercent()+"%",this.active.style.backgroundSize=this.wrapper.offsetWidth+"px 100%",window.onresize=(()=>{this.active.style.backgroundSize=this.wrapper.offsetWidth+"px 100%"}).bind(this),this.wrapper.appendChild(this.active)}getProgressInPercent(){return 100/this.slider.max*this.slider.value}}function initRangeSliders(){document.querySelectorAll("[data-callone-range]").forEach(t=>{new Range(t)})}initRangeSliders(),document.body.addEventListener("click",initRangeSliders);
const selectBoxes=document.querySelectorAll("[data-callone-select]");selectValue=e=>{let l=e.currentTarget,t=l;for(;(t=t.parentNode)&&!t.classList.contains("callone-select"););let c=t.querySelector(".callone-select__selected");c.innerHTML=l.textContent;let a=document.createElement("div");a.classList.add("callone-select__clear"),c.appendChild(a),a.addEventListener("click",deselectValue),t.querySelector(".callone-select__label").classList.add("callone-select__label--active"),t.querySelector("select").value=l.dataset.value},deselectValue=e=>{e.stopPropagation();let l=e.currentTarget;for(;(l=l.parentNode)&&!l.classList.contains("callone-select"););for(var t=l.querySelector("select").options,c=0;c<t.length;c++)t[c].selected=!1;l.querySelector(".callone-select__selected").innerHTML="&nbsp;",l.querySelector(".callone-select__label").classList.remove("callone-select__label--active")},selectBoxes.forEach(e=>{let l=document.createElement("div");l.classList.add("callone-select"),e.parentNode.insertBefore(l,e),l.appendChild(e);let t=document.createElement("div");t.classList.add("callone-select__label"),t.innerHTML=e.options[0].text,l.appendChild(t);let c=document.createElement("div");c.classList.add("callone-select__selected"),c.innerHTML="&nbsp;",l.appendChild(c);let a=document.createElement("ul");a.classList.add("callone-select__options");for(let l=1;l<e.options.length;l++){let t=e.options[l],c=document.createElement("li");c.dataset.value=t.getAttribute("value"),c.classList.add("callone-select__option"),c.innerHTML=t.text,a.appendChild(c),c.addEventListener("click",selectValue)}l.appendChild(a),l.addEventListener("click",e=>{e.stopPropagation(),l.classList.toggle("callone-select--open")})}),window.addEventListener("click",e=>{document.querySelectorAll(".callone-select").forEach(l=>{l===e.target||l.contains(e.target)||l.classList.remove("callone-select--open")})});
class stepSlider{constructor(t){this.dragging=!1,this.slider=t,this.steps=this.slider.querySelector(".step-slider__steps"),this.rangeWrapper=this.slider.querySelector(".step-slider__slider"),this.range=this.slider.querySelector(".step-slider__range"),this.allSteps=this.steps.querySelectorAll(".step-slider__step"),this.stepCount=this.allSteps.length,this.handle=this.slider.querySelector(".step-slider__handle"),this.calculateStepsWidth(),this.rangeWrapper.addEventListener("mousedown",(t=>{this.dragging=!0}).bind(this)),window.addEventListener("mouseup",(t=>{this.dragging=!1}).bind(this)),window.addEventListener("mousemove",this.drag.bind(this)),this.rangeWrapper.addEventListener("touchstart",(t=>{this.dragging=!0}).bind(this)),window.addEventListener("touchend",(t=>{this.dragging=!1}).bind(this)),window.addEventListener("touchmove",this.drag.bind(this))}calculateStepsWidth(){let t=270*this.stepCount+30*(this.stepCount-1);this.steps.style.width=t+"px"}drag(t){if(!this.dragging)return!1;let e=this.range.getBoundingClientRect(),s=this.getMousePosition(t),i=this.handle.offsetWidth/2;s.x-=i;let r=100/e.width*(s.x-e.x);r<0&&(r=0),r>100&&(r=100),this.handle.style.left=r+"%";let d=this.slider.getBoundingClientRect(),n=(this.steps.getBoundingClientRect().width-d.width)*(r/100),h=Math.floor(r/(100/this.stepCount));h>=this.stepCount&&(h=this.stepCount-1),this.allSteps.forEach((t,e)=>{t.classList.remove("step-slider__step--active"),e==h&&t.classList.add("step-slider__step--active")}),this.steps.style.transform="translateX(-"+n+"px)"}getMousePosition(t){let e={x:t.pageX,y:t.pageY};if("touchmove"==t.type){var s=void 0===t.originalEvent?t:t.originalEvent;let i=s.touches[0]||s.changedTouches[0];e.x=i.pageX,e.y=i.pageY}return e}}let stepSliders=document.querySelectorAll(".step-slider");stepSliders.forEach(t=>{new stepSlider(t)});
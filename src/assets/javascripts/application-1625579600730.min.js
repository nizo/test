var app,navbar,slider;window.NodeList&&!NodeList.prototype.forEach&&(NodeList.prototype.forEach=Array.prototype.forEach),app={init:function(){return navbar.init(".navbar"),this.bind_events(),this.init_slider(),this.loop_videos(),this.init_tabs()},bind_events:function(){return this,$(document).on("click",".tab-nav a",(function(e){var t;return e.preventDefault(),t=$(this).closest(".tabs"),$(".tab",t).removeClass("active"),$(".tab-nav a",t).removeClass("active"),$(this).addClass("active"),$(".tab#"+$(this).data("tab"),t).addClass("active")})),$(document).on("click",".form .submit",(function(e){return e.preventDefault(),$(this).parents(".js-form").hasClass("callback")?(console.log("send Callback"),sendCallback($(this).parents(".js-form"))):sendForm($(this).parents(".js-form"))})),$(document).on("click",".openBox",(function(e){var t,i;return e.preventDefault(),$(".SwitchBoxes").toggleClass("hidden"),t=$(this).text(),i=$(this).attr("data-text"),$(this).text(i),$(this).attr("data-text",t)})),$(document).on("click",".container .title",(function(e){return e.preventDefault(),$(this).parent().toggleClass("open"),$(this).next(".content").slideToggle("fast")})),$(document).on("click",".accordion",(function(e){if(e.preventDefault(),$(this).hasClass("open")){if($(this).hasClass("accordion-closeable"))return $(this).removeClass("open"),$(this).children(".content").slideUp("fast")}else if($(".accordion").removeClass("open"),$(this).addClass("open"),$(".accordion .content").slideUp("fast"),$(this).children(".content").slideDown("fast"),$(this).attr("data-link"))return console.log($(this).attr("data-area")),$($(this).attr("data-area")).children().hide(),$($(this).attr("data-area")).children($(this).attr("data-link")).fadeIn()})),$(document).on("click",".footer-menu li span",(function(e){return $(this).closest("li").hasClass("open")?$(this).closest("li").removeClass("open"):($(".footer-menu li").removeClass("open"),$(this).closest("li").addClass("open"))})),$(document).on("click",".mobile-nav .pages-menu .submenu",(function(e){return e.preventDefault(),e.stopPropagation(),$(this).hasClass("submenu-open")?($(this).removeClass("submenu-open"),$(this).next("ul").slideUp("fast")):($(".pages-submenu").slideUp("fast"),$(".pages-menu .submenu-open").removeClass("submenu-open"),$(this).addClass("submenu-open"),$(this).next("ul").slideDown("fast"))})),$(".btn-mobile-nav").on("click",(function(e){return e.preventDefault(),$(this).parent().next(".mobile-nav").addClass("open")})),$(".btn-mobile-nav.close").on("click",(function(e){return e.preventDefault(),$(this).parent(".mobile-nav").removeClass("open")})),$('a[href^="#"]').on("click.smoothscroll",(function(e){var t,i;if(e.preventDefault(),i=this.hash)return t=$(i),$("html, body").stop().animate({scrollTop:t.offset().top},500,"swing",(function(){})),window.location.hash=i})),$(document).on("click",".showDiv",(function(e){return e.preventDefault(),$(this).next(".selection").toggleClass("active"),$(this).next(".selection").data("toggle"),$(this).next(".selection").hasClass("active")?$(this).next(".selection").slideDown():$(this).next(".selection").slideUp()})),$(document).on("click",".customCheckbox",(function(e){if($(".showField").addClass("active"),$(".showField").hasClass("active"))return $(".showField").fadeIn()})),$(document).on("click",".expertmode",(function(e){var t;return e.preventDefault(),$(this).toggleClass("active"),t=$(this).data("toggle"),$(this).hasClass("active")?($(".expertmode-on.expertmode-"+t).show(),$(".expertmode-off.expertmode-"+t).hide()):($(".expertmode-on.expertmode-"+t).hide(),$(".expertmode-off.expertmode-"+t).show())})),$(document).on("change",".topic",(function(e){var t,i;return i=$(this).val(),setCookie("co_role","00"+$(this).val(),365),$(".subtopic, .topic-box").hide(),$('.subtopic[data-subtopic="'+i+'"]').show(),t=$('.subtopic[data-subtopic="'+i+'"]').val(),$('.topic-box[data-topic="'+t+'"]').show()})),$(document).on("change",".subtopic",(function(e){var t;return t=$(this).val(),$(".topic-box").hide(),$('.topic-box[data-topic="'+t+'"]').show()})),$(document).on("click",".toggle-box label",(function(e){return $(this).parent().find(".toggle-box__content").slideToggle()}))},loop_videos:function(){return $.each($("video[data-loop]"),(function(e,t){var i;return i=parseFloat($(this).data("loop")),t.addEventListener("ended",(function(){return this.currentTime=i,this.play()}),!1)}))},init_tabs:function(){return $.each($(".tabs"),(function(e,t){return $(".tab-nav a:eq(0), .tab:eq(0)",$(this)).addClass("active")}))},init_slider:function(){return $.each($(".slider"),(function(e,t){return slider.init($(t))}))}},navbar={n:"",n_height:0,n_top:0,d_height:0,w_height:0,w_scroll_current:0,w_scroll_before:0,w_scroll_diff:0,init:function(e){if(this.n=document.querySelector(e),this.n&&(this.bind_events(),window.pageYOffset>0))return $(this.n).addClass("background")},bind_events:function(){return $(window).scroll((function(e){return navbar.scroll()}))},scroll:function(){return this.n_height=this.n.offsetHeight,this.d_height=document.body.offsetHeight,this.w_height=window.innerHeight,this.w_scroll_current=window.pageYOffset,this.w_scroll_diff=this.w_scroll_before-this.w_scroll_current,this.n_top=parseInt(window.getComputedStyle(this.n).getPropertyValue("top"))+this.w_scroll_diff,this.w_scroll_current>=this.n_height&&$(this.n).addClass("background"),0===this.w_scroll_current&&$(this.n).removeClass("background"),this.w_scroll_current<=0?this.n.style.top="0px":this.w_scroll_diff>0?this.n.style.top=(this.n_top>0?0:this.n_top)+"px":this.w_scroll_diff<0&&(this.w_scroll_current+this.w_height>=this.d_height-this.n_height?this.n.style.top=((this.n_top=this.w_scroll_current+this.w_height-this.d_height)<0?this.n_top:0)+"px":this.n.style.top=(Math.abs(this.n_top)>this.n_height?-this.n_height:this.n_top)+"px"),this.w_scroll_before=this.w_scroll_current}},slider={slider:"",slides_box:"",slides:"",slider_height:0,slide_width:0,current_slide:0,init:function(e){return this.slider=e,this.slides_box=$(".slides",this.slider),this.slides=$(".slide",this.slider),this.get_slider_height(),this.init_slider_nav(),this.slide_width=$(this.slides[0]).outerWidth(),this.bind_events(),$(this.slides[0]).addClass("active"),$(this.slides[1]).addClass("active"),$(this.slides[2]).addClass("active")},bind_events:function(){var e;return e=this,$(window).resize((function(){return $(".slider .slide").css("width",$(".slider").outerWidth()/3+"px"),e.get_slider_height()}))},get_slider_height:function(){var e;return 173,e=this,$.each(this.slides,(function(t,i){if($(i).outerHeight()>e.slider_height)return e.slider_height=$(i).outerHeight()})),this.slider.css("height",this.slider_height+173+"px"),$(".slide-content",this.slider).css("height",this.slider_height+"px")},init_slider_nav:function(){var e,t,i;for(t=0,i=[];t<this.slides.length-2;)this,(e=$("<div class='btn-slider-nav' data-slide='"+t+"'></div>")).on("click",(function(e){var t,i;return slider=$(this).closest(".slider"),t=$(this).data("slide"),i=$(".slider").outerWidth()/3,$(".slides",slider).animate({left:t*i*-1+"px"},300),$(".btn-slider-nav",slider).removeClass("active"),$(".btn-slider-nav:eq("+t+")",slider).addClass("active"),$(".slide",slider).removeClass("active"),$(".slide:eq("+t+")",slider).addClass("active"),$(".slide:eq("+(t+1)+")",slider).addClass("active"),$(".slide:eq("+(t+2)+")",slider).addClass("active")})),0===t&&e.addClass("active"),$(".slider-navigation",this.slider).append(e),i.push(t++);return i}},$(document).ready((function(){var e,t,i,r,s,n,o,a,c,l;return app.init(),document.querySelectorAll(".customer-slider").forEach((function(e){var t,i,r,s;return r=1,s=e.querySelectorAll(".customer-slider__slide").length,t=e.querySelector(".customer-slider__arrow--left"),i=e.querySelector(".customer-slider__arrow--right"),e.querySelector(".customer-slider__slide:nth-child("+r+")").classList.add("customer-slider__slide--active"),t.addEventListener("click",(function(t){return e.querySelectorAll(".customer-slider__slide").forEach((function(e){return e.classList.remove("customer-slider__slide--active")})),0===--r&&(r=s),e.querySelector(".customer-slider__slide:nth-child("+r+")").classList.add("customer-slider__slide--active")})),i.addEventListener("click",(function(t){return e.querySelectorAll(".customer-slider__slide").forEach((function(e){return e.classList.remove("customer-slider__slide--active")})),++r>s&&(r=1),e.querySelector(".customer-slider__slide:nth-child("+r+")").classList.add("customer-slider__slide--active")}))})),a=function(e){var t;return(t=e.getBoundingClientRect()).top>=0&&t.left>=0&&t.bottom<=(window.innerHeight||document.documentElement.clientHeight)&&t.right<=(window.innerWidth||document.documentElement.clientWidth)},document.querySelectorAll(".tabset").forEach((function(e){var t;return e.querySelector(".tabset__tab:first-of-type").classList.add("tabset__tab--active"),e.querySelector(".tabset__link:first-of-type").classList.add("tabset__link--active"),t=e.querySelectorAll(".tabset__link"),window.addEventListener("scroll",(function(t){var i;if(i=e.querySelector(".tabset__tab:first-of-type .tabset__video video"),a(i)&&i.paused)return i.currentTime=0,i.loop=!0,i.muted=!0,i.play()})),t.forEach((function(t){return t.addEventListener("click",(function(i){var r;return e.querySelector(".tabset__tab--active").classList.remove("tabset__tab--active"),e.querySelector(".tabset__link--active").classList.remove("tabset__link--active"),e.querySelector('.tabset__tab[data-tab="'+t.dataset.tab+'"]').classList.add("tabset__tab--active"),e.querySelector('.tabset__link[data-tab="'+t.dataset.tab+'"]').classList.add("tabset__link--active"),(r=e.querySelector(".tabset__tab--active .tabset__video video")).currentTime=0,r.loop=!0,r.muted=!0,r.play()}),!1)}))})),document.querySelectorAll(".compare").forEach((function(e){var t;return(t=e.querySelector(".compare__switch input")).checked?e.querySelector('.compare__content[data-compare="on"]').classList.add("compare__content--active"):e.querySelector('.compare__content[data-compare="off"]').classList.add("compare__content--active"),t.addEventListener("change",(function(t){return e.querySelector('.compare__content[data-compare="off"]').classList.toggle("compare__content--active"),e.querySelector('.compare__content[data-compare="on"]').classList.toggle("compare__content--active")}),!1)})),s=1,document.querySelectorAll(".pricetoggle__button").length>0&&(document.querySelector('.pricetoggle__button[data-pricebox="'+s+'"]').classList.add("pricetoggle__button--active"),document.querySelector('.pricetoggle__stickybutton[data-pricebox="'+s+'"]').classList.add("pricetoggle__stickybutton--active"),document.querySelectorAll('.pricetoggle__content[data-pricebox="'+s+'"]').forEach((function(e){return e.classList.add("pricetoggle__content--active")})),document.querySelectorAll(".pricetoggle__button").forEach((function(e){return e.addEventListener("click",(function(t){return document.querySelector('.pricetoggle__button[data-pricebox="'+s+'"]').classList.remove("pricetoggle__button--active"),document.querySelector('.pricetoggle__stickybutton[data-pricebox="'+s+'"]').classList.remove("pricetoggle__stickybutton--active"),document.querySelectorAll('.pricetoggle__content[data-pricebox="'+s+'"]').forEach((function(e){return e.classList.remove("pricetoggle__content--active")})),s=e.dataset.pricebox,document.querySelector('.pricetoggle__button[data-pricebox="'+s+'"]').classList.add("pricetoggle__button--active"),document.querySelector('.pricetoggle__stickybutton[data-pricebox="'+s+'"]').classList.add("pricetoggle__stickybutton--active"),document.querySelectorAll('.pricetoggle__content[data-pricebox="'+s+'"]').forEach((function(e){return e.classList.add("pricetoggle__content--active")}))}),!1)})),document.querySelectorAll(".pricetoggle__stickybutton").forEach((function(e){return e.addEventListener("click",(function(t){return document.querySelector('.pricetoggle__button[data-pricebox="'+e.dataset.pricebox+'"]').click()}))})),window.addEventListener("scroll",(function(e){var t,i,r;return r=document.querySelector(".pricetoggle__buttons"),t=document.getElementById("preise"),i=document.querySelector(".pricetoggle__sticky"),r.offsetTop-window.scrollY<0&&window.scrollY<t.offsetHeight+t.offsetTop-window.innerHeight/2?i.classList.add("pricetoggle__sticky--active"):i.classList.remove("pricetoggle__sticky--active")}))),25,500,document.querySelectorAll(".usercalc").length>0&&document.querySelectorAll(".usercalc").forEach((function(e){var t,i,r,s,a,c,l,d,u,h;return h=e.querySelector(".usercalc__users"),c=e.querySelector(".usercalc__price"),s=e.querySelector(".usercalc__form"),l=e.querySelector(".usercalc__result"),d=e.querySelectorAll(".usercalc__submit"),slider=e.querySelector(".usercalc__slider input"),u=e.querySelector(".usercalc__total span"),t=e.querySelector("#callcenter-software"),i=e.querySelector(".usercalc__callcenter"),r=247.5,a=!1,slider.addEventListener("input",(function(e){return h.value=parseInt(this.value),c.innerHTML=n(parseInt(this.value)),r=o(parseInt(this.value))}),!1),h.addEventListener("change",(function(e){var t;return(t=parseInt(this.value))<25||t>500?(h.value=25,slider.value=25,c.innerHTML=n(25),r=o(25)):(slider.value=t,c.innerHTML=n(this.value),r=o(this.value))})),t.addEventListener("change",(function(e){return a=this.checked})),d.forEach((function(e){return e.addEventListener("click",(function(e){var t;return e.preventDefault(),s.classList.toggle("usercalc__form--inactive"),l.classList.toggle("usercalc__result--active"),a?i.classList.add("usercalc__callcenter--active"):i.classList.remove("usercalc__callcenter--active"),t=Math.round(100*r)/100,u.innerHTML=t.toString().replace(".",",")+" &euro;"}))}))})),o=function(e){var t;return t=9.9,e>=50&&(t=8.9),e>=250&&(t=7.9),t*e},n=function(e){var t;return t="9,90 &euro;",e>=50&&(t="8,90 &euro;"),e>=250&&(t="7,90 &euro;"),t},"chrome",r="chrome",(r=-1!==navigator.userAgent.indexOf("Edg")||-1!==navigator.userAgent.indexOf("Edge")?"edge":-1!==navigator.userAgent.indexOf("Chrome")?"chrome":-1!==navigator.userAgent.indexOf("Firefox")?"firefox":-1!==navigator.userAgent.indexOf("MSIE")||!0==!!document.documentMode?"edge":"chrome")&&(t=document.querySelector('.installation__browser[data-browser="'+r+'"]'),i=document.querySelector('.installation__button[data-browser="'+r+'"]'),e=document.querySelector('.browsers__browser[data-browser="'+r+'"]'),t&&i&&(t.classList.add("installation__browser--active"),i.classList.add("installation__button--active")),e&&e.classList.add("browsers__browser--active")),document.querySelectorAll(".installation__browser").forEach((function(e){return e.addEventListener("click",(function(t){var i,s,n;if(t.preventDefault(),i=e.getAttribute("data-browser"),r!==i)return r=i,s=document.querySelector(".installation__browser--active"),n=document.querySelector(".installation__button--active"),s&&n&&(s.classList.remove("installation__browser--active"),n.classList.remove("installation__button--active")),document.querySelector('.installation__browser[data-browser="'+i+'"]').classList.add("installation__browser--active"),document.querySelector('.installation__button[data-browser="'+i+'"]').classList.add("installation__button--active")}))})),c=document.querySelectorAll(".scroller"),l=0,c.forEach((function(e){var t,i,r,s,n,o,a,d,u,h,_,v,p,f,g;if((e=c[l]).style.height=e.dataset.height+"px",g=e.dataset.height,v=e.querySelector(".scroller-belt"),(p=v.offsetHeight)>0){for(f=!1,e.hasAttribute("data-reversed")&&(f=!0),u=g,o=p,s=0;u>=o;)u-=o,s++;for(s++,h=v.innerHTML,d=0;d<s;)v.innerHTML+=h,d++;n=0,f&&(n=p),r=40,t=null,i=!1}return _=function(){var e;if(!i)return e=r/24,f?(n-=e)<=0&&(n=p):(n+=e)>=p&&(n=0),v.style.marginTop="-"+n+"px"},e.addEventListener("mouseenter",(function(e){return i=!0}),!1),e.addEventListener("mouseleave",(function(e){return i=!1}),!1),(a=function(){return clearInterval(t),window.innerWidth<=800?(n=f?p:0,v.style.marginTop="-"+n+"px"):t=setInterval(_,1e3/24)})(),window.addEventListener("resize",(function(e){return a()})),l++}))}));
...
class Modal{constructor(t){this.namespace="callone-modal",this.button=t,this.modal=null,this.steps=null,this.activeStep=null,this.currentStep=1,this.modalWrapper=null,this.modalHeader=null,this.modalContent=null,this.closeButton=null,this.button.addEventListener("click",this.openModal.bind(this))}loadModalContent(){this.modal=document.querySelector('[data-modal="'+this.button.dataset.openmodal+'"]'),this.modal?this.initModal():this.modal=this.getModalContent(this.button.dataset.openmodal)}initModal(){this.steps=this.modal.querySelectorAll("."+this.namespace+"__step"),this.modal.querySelector("."+this.namespace+"__wrapper")?this.modalWrapper=this.modal.querySelector("."+this.namespace+"__wrapper"):(this.modalWrapper=document.createElement("div"),this.modalWrapper.classList.add(this.namespace+"__wrapper")),this.modal.querySelector("."+this.namespace+"__header")?this.modalHeader=this.modal.querySelector("."+this.namespace+"__header"):(this.modalHeader=document.createElement("div"),this.modalHeader.classList.add(this.namespace+"__header"),this.modalWrapper.appendChild(this.modalHeader)),this.modal.querySelector("."+this.namespace+"__headerbutton--close")?this.closeButton=this.modal.querySelector("."+this.namespace+"__headerbutton--close"):(this.closeButton=document.createElement("div"),this.closeButton.classList.add(this.namespace+"__headerbutton"),this.closeButton.classList.add(this.namespace+"__headerbutton--close"),this.closeButton.textContent=this.modal.dataset.canceltext||"Schließen",this.closeButton.addEventListener("click",this.closeModal.bind(this)),this.modalHeader.appendChild(this.closeButton));let t=document.createElement("div");if(t.classList.add(this.namespace+"__title"),!this.modal.querySelector("."+this.namespace+"__title")){if(this.steps.length>0){this.activeStep=this.getActiveStep();let e=document.createElement("div");e.classList.add(this.namespace+"__steptitle"),this.activeStep.dataset.steptitle&&""!==this.activeStep.dataset.steptitle?e.textContent=this.activeStep.dataset.steptitle:e.textContent="Schritt "+(this.activeStep.dataset.stepIndicator||this.activeStep.dataset.stepId),t.appendChild(e);let s=document.createElement("div");if(s.classList.add(this.namespace+"__step-indicators"),this.activeStep.dataset.stepIndicator){let t=this.activeStep.dataset.stepIndicator.split("/"),e=parseInt(t[0]),a=parseInt(t[1]);for(let t=1;t<=a;t++){let a=document.createElement("div");a.classList.add(this.namespace+"__step-indicator"),t==e&&a.classList.add(this.namespace+"__step-indicator--active"),s.appendChild(a)}}t.appendChild(s),this.activeStep.classList.add(this.namespace+"__step--active");let a=document.createElement("div");a.classList.add(this.namespace+"__headerbutton"),a.classList.add(this.namespace+"__headerbutton--back"),a.classList.add(this.namespace+"__headerbutton--hidden"),a.textContent="Schritt zurück",a.addEventListener("click",this.prevStep.bind(this)),this.modalHeader.appendChild(a)}else{t.innerHTML=this.modal.dataset.title;let e=document.createElement("span");e.textContent=this.modal.dataset.subtitle,t.appendChild(e)}this.modalHeader.appendChild(t)}this.modal.querySelector("."+this.namespace+"__content")?this.modalContent=this.modal.querySelector("."+this.namespace+"__content"):(this.modalContent=document.createElement("div"),this.modalContent.classList.add(this.namespace+"__content"),this.modalContent.innerHTML=this.modal.innerHTML,this.modalWrapper.appendChild(this.modalContent));let e=this.modalContent.querySelectorAll("."+this.namespace+"__nextstep");e.length>0&&e.forEach(t=>{t.addEventListener("click",this.nextStep.bind(this))});let s=this.modalContent.querySelectorAll("form");s.length>0&&s.forEach(t=>{t.addEventListener("submit",this.submitStep.bind(this))}),this.modal.innerHTML="",this.modal.appendChild(this.modalWrapper),this.modal.addEventListener("mousedown",(t=>{this.modal==t.target&&this.closeModal()}).bind(this)),this.openModal()}submitStep(t){t.preventDefault(),"function"==typeof window[t.target.dataset.stepCallback]&&window[t.target.dataset.stepCallback](t,this.nextStep.bind(this,t))}nextStep(t){t.preventDefault(),this.currentStep=parseInt(t.target.dataset.nextStep),this.switchStep()}prevStep(){this.currentStep=parseInt(this.activeStep.dataset.prevStep),this.switchStep()}getActiveStep(){let t=null;return this.steps=this.modal.querySelectorAll("."+this.namespace+"__step"),this.steps.forEach(e=>{e.hasAttribute("data-step-id")&&parseInt(e.getAttribute("data-step-id"))===this.currentStep&&(t=e)}),t}switchStep(){this.activeStep=this.getActiveStep();let t=this.modal.querySelector("."+this.namespace+"__steptitle"),e=this.modal.querySelector("."+this.namespace+"__step-indicators"),s=this.modal.querySelector("."+this.namespace+"__headerbutton--back");if(this.closeButton.textContent=this.activeStep.dataset.canceltext||this.modal.dataset.canceltext||"Schließen",e.innerHTML="",this.activeStep.dataset.stepIndicator){let t=this.activeStep.dataset.stepIndicator.split("/"),s=parseInt(t[0]),a=parseInt(t[1]);for(let t=1;t<=a;t++){let a=document.createElement("div");a.classList.add(this.namespace+"__step-indicator"),t==s&&a.classList.add(this.namespace+"__step-indicator--active"),t<s&&a.classList.add(this.namespace+"__step-indicator--past"),e.appendChild(a)}}if(this.activeStep.dataset.stepNoscroll&&"true"===this.activeStep.dataset.stepNoscroll){this.modalContent.classList.add(this.namespace+"__content--scrolllock");let t=this.activeStep.querySelector(".calendly-inline-widget");if(t){t.style.height=.8*window.innerHeight-this.modalHeader.offsetHeight+"px",window.innerWidth<=830&&(t.style.height="calc("+(window.innerHeight-this.modalHeader.offsetHeight)+"px - 60px)");let e=window.getComputedStyle(this.modalContent,null),s={top:parseInt(e.getPropertyValue("padding-top")),right:parseInt(e.getPropertyValue("padding-right")),bottom:parseInt(e.getPropertyValue("padding-bottom")),left:parseInt(e.getPropertyValue("padding-left"))};t.style.marginTop=-s.top+"px",t.style.marginRight=-s.right+"px",t.style.marginBottom=-s.bottom+"px",t.style.marginLeft=-s.left+"px"}}else this.modalContent.classList.remove(this.namespace+"__content--scrolllock");this.steps.forEach(t=>t.classList.remove(this.namespace+"__step--active")),this.activeStep.classList.add(this.namespace+"__step--active"),this.activeStep.dataset.steptitle&&""!=this.activeStep.dataset.steptitle?t.textContent=this.activeStep.dataset.steptitle:t.textContent="Schritt "+(this.activeStep.dataset.stepIndicator||this.activeStep.dataset.stepId),this.currentStep>1?s.classList.remove(this.namespace+"__headerbutton--hidden"):s.classList.add(this.namespace+"__headerbutton--hidden")}runScripts(){let scripts=this.modal.querySelectorAll("script");scripts.forEach(script=>{if(script.hasAttribute("src")){let t=document.createElement("script");t.setAttribute("src",script.getAttribute("src")),script.parentNode.insertBefore(t,script),script.remove()}eval(script.textContent)})}openModal(t=new MouseEvent("click")){t.preventDefault(),this.modal?(document.body.classList.add("callone-modal--scrolllock"),this.runScripts(),$(this.modal).css("display","flex").hide().fadeIn(300),this.modal.classList.add(this.namespace+"--open")):this.loadModalContent()}closeModal(){$(this.modal).fadeOut(300,function(){document.body.classList.remove("callone-modal--scrolllock"),this.modal.classList.remove(this.namespace+"--open"),this.currentStep=1,this.switchStep()}.bind(this))}getModalContent(t){const e=new XMLHttpRequest;e.onreadystatechange=function(){if(e.readyState===XMLHttpRequest.DONE&&200==e.status){let t=e.response,s=document.createElement("div");s.innerHTML=t,this.modal=s.querySelector(".callone-modal"),document.body.appendChild(this.modal),this.initModal()}}.bind(this),e.open("GET","/partials/modals/"+t+".php",!0),e.overrideMimeType("text/plain; charset=utf-8"),e.send()}}let modalButtons=document.querySelectorAll("[data-openmodal]");modalButtons.forEach(t=>{new Modal(t)});
 ...
 */
class Range{constructor(t){this.classNamespace="callone-range",this.slider=t,this.slider.dataset.initialized&&"true"==this.slider.dataset.initialized||(this.slider.dataset.initialized="true",this.step=100/(this.slider.max/this.slider.step),this.size={width:this.slider.dataset.width||480,height:this.slider.dataset.height||25},this.dragging=!1,this.wrapper=document.createElement("div"),this.track=document.createElement("div"),this.thumb=document.createElement("div"),this.active=document.createElement("div"),this.output=null,this.slider.hasAttribute("data-output")&&(this.output=document.querySelector(this.slider.dataset.output)),this.output&&(this.setOutputValue(),this.slider.addEventListener("change",this.setOutputValue.bind(this)),this.output.addEventListener("keyup",this.setProgress.bind(this))),this.wrapper.style.width=this.size.width+"px",this.wrapper.style.height=this.size.height+"px",this.wrap(),this.addTrack(),this.addThumb(),this.addActive(),this.wrapper.addEventListener("click",this.changeProgress.bind(this)),this.wrapper.addEventListener("mousedown",(()=>{this.dragging=!0}).bind(this)),window.addEventListener("mouseup",(()=>{this.dragging=!1}).bind(this)),window.addEventListener("mousemove",(t=>{this.dragging&&this.changeProgress(t)}).bind(this)),this.thumb.addEventListener("touchstart",(()=>{this.dragging=!0}).bind(this),{passive:!0}),window.addEventListener("touchend",(()=>{this.dragging=!1}).bind(this),{passive:!0}),window.addEventListener("touchmove",(t=>{this.dragging&&this.changeProgress(t)}).bind(this),{passive:!0}))}setOutputValue(){this.output.value=this.slider.value}setProgress(t){let e=t.which||t.keyCode,i=parseInt(this.output.value);38==e&&i++,40==e&&i--;let s=parseInt(this.slider.min),a=parseInt(this.slider.max);i||(i=0),i<s&&(i=s),i>a&&(i=a),this.output.value=i;let h=100/(a-s)*(i-s);this.thumb.style.left=h+"%",this.active.style.width=h+"%",this.slider.value=i;let d=new Event("change");this.slider.dispatchEvent(d)}changeProgress(t){let e=this.wrapper.getBoundingClientRect(),i={x:t.pageX,y:t.pageY};if("touchmove"==t.type){var s=void 0===t.originalEvent?t:t.originalEvent;let e=s.touches[0]||s.changedTouches[0];i.x=e.pageX,i.y=e.pageY}let a=100/e.width*(i.x-e.x);a-=a%this.step,a<0&&(a=0),a>100&&(a=100),this.thumb.style.left=a+"%",this.active.style.width=a+"%",this.slider.value=this.slider.max*(a/100);let h=new Event("change");this.slider.dispatchEvent(h)}wrap(){this.wrapper.classList.add(this.classNamespace),this.slider.parentNode.insertBefore(this.wrapper,this.slider),this.wrapper.appendChild(this.slider)}addTrack(){this.track.classList.add(this.classNamespace+"__track"),this.wrapper.appendChild(this.track)}addThumb(){this.thumb.classList.add(this.classNamespace+"__thumb"),this.thumb.style.left=this.getProgressInPercent()+"%",this.wrapper.appendChild(this.thumb)}addActive(){this.active.classList.add(this.classNamespace+"__active"),this.active.style.width=this.getProgressInPercent()+"%",this.active.style.backgroundSize=this.size.width+"px 100%",window.onresize=(()=>{this.wrapper.offsetParent&&(this.active.style.backgroundSize=this.wrapper.offsetWidth+"px 100%")}).bind(this),this.wrapper.appendChild(this.active)}getProgressInPercent(){return 100/this.slider.max*this.slider.value}}function initRangeSliders(){document.querySelectorAll("[data-callone-range]").forEach(t=>{new Range(t)})}initRangeSliders();
class Select{constructor(e){if(this.select=e,!this.select.dataset.initialized||"true"!=this.select.dataset.initialized){this.select.dataset.initialized="true",this.wrapper=document.createElement("div"),this.wrapper.classList.add("callone-select"),this.select.parentNode.insertBefore(this.wrapper,this.select),this.wrapper.appendChild(this.select),this.selectLabel=document.createElement("div"),this.selectLabel.classList.add("callone-select__label"),this.selectLabel.innerHTML=this.select.options[0].text,this.wrapper.appendChild(this.selectLabel),this.selected=document.createElement("div"),this.selected.classList.add("callone-select__selected"),this.selected.innerHTML="&nbsp;",this.wrapper.appendChild(this.selected),this.selectOptions=document.createElement("ul"),this.selectOptions.classList.add("callone-select__options");for(let e=1;e<this.select.options.length;e++){let t=this.select.options[e],s=document.createElement("li");s.dataset.value=t.getAttribute("value"),s.classList.add("callone-select__option"),s.innerHTML=t.text,this.selectOptions.appendChild(s),s.addEventListener("click",this.selectValue.bind(this))}this.wrapper.appendChild(this.selectOptions),this.wrapper.addEventListener("click",(e=>{e.stopPropagation(),this.wrapper.classList.toggle("callone-select--open")}).bind(this))}}selectValue(e){let t=e.currentTarget;this.selected.innerHTML=t.textContent;let s=document.createElement("div");s.classList.add("callone-select__clear"),this.selected.appendChild(s),s.addEventListener("click",this.deselectValue.bind(this)),this.selectLabel.classList.add("callone-select__label--active"),this.select.value=t.dataset.value}deselectValue(e){e.stopPropagation();e.currentTarget;for(var t=this.select.options,s=0;s<t.length;s++)t[s].selected=!1;this.selected.innerHTML="&nbsp;",this.selectLabel.classList.remove("callone-select__label--active")}}const selectBoxes=document.querySelectorAll("[data-callone-select]");selectBoxes.forEach(e=>{new Select(e)}),window.addEventListener("click",e=>{document.querySelectorAll(".callone-select").forEach(t=>{t===e.target||t.contains(e.target)||t.classList.remove("callone-select--open")})});
class stepSlider{constructor(t){this.dragging=!1,this.slider=t,this.slider.dataset.initialized&&"true"==this.slider.dataset.initialized||(this.slider.dataset.initialized="true",this.steps=this.slider.querySelector(".step-slider__steps"),this.rangeWrapper=this.slider.querySelector(".step-slider__slider"),this.range=this.slider.querySelector(".step-slider__range"),this.allSteps=this.steps.querySelectorAll(".step-slider__step"),this.stepCount=this.allSteps.length,this.handle=this.slider.querySelector(".step-slider__handle"),this.calculateStepsWidth(),this.rangeWrapper.addEventListener("mousedown",(t=>{this.dragging=!0}).bind(this)),window.addEventListener("mouseup",(t=>{this.dragging=!1}).bind(this)),window.addEventListener("mousemove",this.drag.bind(this)),this.rangeWrapper.addEventListener("touchstart",(t=>{this.dragging=!0}).bind(this),{passive:!0}),window.addEventListener("touchend",(t=>{this.dragging=!1}).bind(this),{passive:!0}),window.addEventListener("touchmove",this.drag.bind(this),{passive:!0}))}calculateStepsWidth(){let t=270*this.stepCount+30*(this.stepCount-1);this.steps.style.width=t+"px"}drag(t){if(!this.dragging)return!1;let e=this.range.getBoundingClientRect(),s=this.getMousePosition(t),i=this.handle.offsetWidth/2;s.x-=i;let d=100/e.width*(s.x-e.x);d<0&&(d=0),d>100&&(d=100),this.handle.style.left=d+"%";let r=this.slider.getBoundingClientRect(),n=(this.steps.getBoundingClientRect().width-r.width)*(d/100),l=Math.floor(d/(100/this.stepCount));l>=this.stepCount&&(l=this.stepCount-1),this.allSteps.forEach((t,e)=>{t.classList.remove("step-slider__step--active"),e==l&&t.classList.add("step-slider__step--active")}),this.steps.style.transform="translateX(-"+n+"px)"}getMousePosition(t){let e={x:t.pageX,y:t.pageY};if("touchmove"==t.type){var s=void 0===t.originalEvent?t:t.originalEvent;let i=s.touches[0]||s.changedTouches[0];e.x=i.pageX,e.y=i.pageY}return e}}let stepSliders=document.querySelectorAll(".step-slider");stepSliders.forEach(t=>{new stepSlider(t)});
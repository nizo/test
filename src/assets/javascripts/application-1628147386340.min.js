...
class stepSlider{constructor(t){this.dragging=!1,this.slider=t,this.slider.dataset.initialized&&"true"==this.slider.dataset.initialized||(this.slider.dataset.initialized="true",this.steps=this.slider.querySelector(".step-slider__steps"),this.rangeWrapper=this.slider.querySelector(".step-slider__slider"),this.range=this.slider.querySelector(".step-slider__range"),this.allSteps=this.steps.querySelectorAll(".step-slider__step"),this.stepCount=this.allSteps.length,this.handle=this.slider.querySelector(".step-slider__handle"),this.setStepFirstActive(),this.calculateStepsWidth(),this.rangeWrapper.addEventListener("mousedown",(t=>{this.dragging=!0}).bind(this)),window.addEventListener("mouseup",(t=>{this.dragging=!1}).bind(this)),window.addEventListener("mousemove",this.drag.bind(this)),this.rangeWrapper.addEventListener("touchstart",(t=>{this.dragging=!0}).bind(this),{passive:!0}),window.addEventListener("touchend",(t=>{this.dragging=!1}).bind(this),{passive:!0}),window.addEventListener("touchmove",this.drag.bind(this),{passive:!0}))}setStepFirstActive(){let t=this.allSteps[0];t.classList.add("step-slider__step--active");let e=t.querySelector("img[data-alt-image]");if(e){let t=e.src;e.src=e.dataset.altImage,e.dataset.altImage=t}}calculateStepsWidth(){let t=270*this.stepCount+30*(this.stepCount-1);this.steps.style.width=t+"px"}drag(t){if(!this.dragging)return!1;let e=this.range.getBoundingClientRect(),s=this.getMousePosition(t),i=this.handle.offsetWidth/2;s.x-=i;let a=100/e.width*(s.x-e.x);a<0&&(a=0),a>100&&(a=100),this.handle.style.left=a+"%";let l=this.slider.getBoundingClientRect(),r=(this.steps.getBoundingClientRect().width-l.width)*(a/100),d=Math.floor(a/(100/this.stepCount));d>=this.stepCount&&(d=this.stepCount-1),this.allSteps.forEach((t,e)=>{if(t.classList.contains("step-slider__step--active")){t.classList.remove("step-slider__step--active");let e=t.querySelector("img[data-alt-image]");if(e){let t=e.src;e.src=e.dataset.altImage,e.dataset.altImage=t}}if(e==d){t.classList.add("step-slider__step--active");let e=t.querySelector("img[data-alt-image]");if(e){let t=e.src;e.src=e.dataset.altImage,e.dataset.altImage=t}}}),this.steps.style.transform="translateX(-"+r+"px)"}getMousePosition(t){let e={x:t.pageX,y:t.pageY};if("touchmove"==t.type){var s=void 0===t.originalEvent?t:t.originalEvent;let i=s.touches[0]||s.changedTouches[0];e.x=i.pageX,e.y=i.pageY}return e}}let stepSliders=document.querySelectorAll(".step-slider");stepSliders.forEach(t=>{new stepSlider(t)});
class Tablist{constructor(t){this.tablist=t,this.tabLinks=this.tablist.querySelectorAll(".tablist__link"),this.tabContents=this.tablist.querySelectorAll(".tablist__content"),this.tabLinks.forEach(t=>t.addEventListener("click",this.switchTab.bind(this)))}switchTab(t){let s=t.currentTarget.dataset.tab;this.tabLinks.forEach(t=>{t.dataset.tab===s?t.classList.add("tablist__link--active"):t.classList.remove("tablist__link--active")}),this.tabContents.forEach(t=>{t.dataset.tab===s?t.classList.add("tablist__content--active"):t.classList.remove("tablist__content--active")})}}const lists=document.querySelectorAll(".tablist");lists.forEach(t=>new Tablist(t));
class Team{constructor(t){this.el=t,this.buttons=this.el.querySelectorAll(".team__button"),this.contents=this.el.querySelectorAll(".team__member"),this.buttons[0].classList.add("team__button--active"),this.contents[0].classList.add("team__member--active"),this.buttons.forEach(t=>t.addEventListener("click",this.switch.bind(this)))}switch(t){let e=t.currentTarget.dataset.member;console.log(t.currentTarget,e),this.buttons.forEach(t=>{t.dataset.member===e?t.classList.add("team__button--active"):t.classList.remove("team__button--active")}),this.contents.forEach(t=>{t.dataset.member===e?t.classList.add("team__member--active"):t.classList.remove("team__member--active")})}}let teams=document.querySelectorAll(".team");teams.forEach(t=>new Team(t));
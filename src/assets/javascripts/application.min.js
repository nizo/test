...
$((function(){document.querySelectorAll("#formMicroSipHint").length>0&&$.ajax({url:"https://connect.callone.io/backend/microsip/ajax.php",cache:!1,type:"GET",data:{mode:"version"},dataType:"json",error:function(e){console.error(JSON.stringify(e))},success:function(e){$("#formMicroSipHint").html("MicroSIP v"+e.version)}}),$("#formMicroSipSubmit").on("click",(function(e){e.preventDefault(),$("#formMicroSipUsername").val().trim().length&&$("#formMicroSipPassword").val().trim().length?($("#formMicroSipSubmit").hide(),$("#formMicroSipHint").html("Bitte warten, Download wird generiert..."),$.ajax({url:"https://connect.callone.io/backend/microsip/ajax.php",cache:!1,type:"POST",data:{mode:"download",username:$("#formMicroSipUsername").val().trim(),password:$("#formMicroSipPassword").val().trim()},dataType:"json",error:function(e){console.error(JSON.stringify(e)),$("#formMicroSipHint").html("Bitte prüfen Sie ihre Anmeldedaten.<br/>Sind diese korrekt, kontaktieren Sie bitte den CallOne Support."),$("#formMicroSipSubmit").show()},success:function(e){if(e.filename){var i=document.createElement("a");if(window.URL&&window.Blob&&"download"in i&&window.atob){var r=function(e,i,r){if(!window.atob||!window.Uint8Array)return null;i=i||"",r=r||512;for(var n=atob(e),o=[],t=0;t<n.length;t+=r){for(var a=n.slice(t,t+r),l=new Array(a.length),c=0;c<a.length;c++)l[c]=a.charCodeAt(c);var d=new Uint8Array(l);o[o.length]=d}return new Blob(o,{type:i})}(e.content,e.mimetype),n=window.URL.createObjectURL(r);i.href=n,i.download=e.filename,i.style.display="none",document.body.appendChild(i),i.click(),window.URL.revokeObjectURL(n),document.body.removeChild(i)}$("#formMicroSipHint").html("Vielen Dank für die Nutzung von CallOne.")}else $("#formMicroSipHint").html("Bitte prüfen Sie ihre Anmeldedaten.<br/>Sind diese korrekt, kontaktieren Sie bitte den CallOne Support."),$("#formMicroSipSubmit").show()}})):$("#formMicroSipHint").html("Bitte prüfen Sie ihre Anmeldedaten.<br/>Sind diese korrekt, kontaktieren Sie bitte den CallOne Support.")}))}));

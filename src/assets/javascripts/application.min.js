...
let toc=document.querySelector("#toc_container");if(toc){window.addEventListener("scroll",t=>{parseInt(window.getComputedStyle(toc).top)==toc.offsetTop-window.scrollY?toc.classList.add("toc_container--stuck"):toc.classList.remove("toc_container--stuck")}),toc.querySelector(".toc_title").addEventListener("click",t=>{toc.classList.toggle("toc_container--open")}),toc.querySelectorAll(".toc_list a").forEach(t=>{t.addEventListener("click",t=>{toc.classList.toggle("toc_container--open")})})}

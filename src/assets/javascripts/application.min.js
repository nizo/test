...
for(var buttons=document.getElementsByClassName("openModal"),i=0;i<buttons.length;i++)buttons[i].addEventListener("click",(function(){var e,o=$(this).attr("data-modal");e=$(this).attr("data-title");var t=$(this).attr("data-modal-part");displayModal(o,null!=e?e:null,null!=t?t:null)}));if(!1===checkCookie("cookiebanner-accepted"))var x=setTimeout((function(){displayModal("cookiebanner")}),1e3);function displayModal(e,o,t){var a=document.getElementsByClassName(e)[0],n=document.getElementsByClassName("close");if(null!=a){if(a.style.display="block","priceCalc"===e){$(".formSuccess").hide();a.getElementsByClassName("title-"+t)[0];for(var i=a.getElementsByClassName(t)[0],l=(a.getElementsByClassName("defaultTitle")[0],a.getElementsByClassName("part")),s=0;s<l.length;s++)l[s].style.display="none";i.style.display="flex"}setTimeout((function(){$(".inputFields").css("display","block")}),500);a.addEventListener("click",(function(e){e.target==a&&$(a).fadeOut("fast")}));for(s=0;s<n.length;s++)n[s].addEventListener("click",(function(){$(a).fadeOut("fast")}))}}function hideModal(e,o){var t=document.getElementsByClassName(e)[0];switch(o){case"fadeOut":$(t).fadeOut("fast");break;case"slideToggle":$(t).slideToggle("slow");break;default:$(t).fadeOut("fast")}}$(".cookieSubmit").on("click",(function(e){e.preventDefault();var o=100;$(this).hasClass("full")?o=111:($("#CookieConf input#marketing").parent().hasClass("checked")&&(o+=10),$("#CookieConf input#extern").parent().hasClass("checked")&&(o+=1)),o>100&&loadLazyTracking(o>101),o<110&&$.ajax({url:"/libs/count.php",data:{optInActive:"1"},type:"POST",success:function(e){}}),setCookie("cookiebanner-accepted",o,365),checkCookie("co_role")||setCookie("co_role","001",365),hideModal("cookiebanner","slideDown"),hideModal("cookiebanner-config","slideDown")})),$(".cookieDeny").on("click",(function(e){e.preventDefault(),setCookie("cookiebanner-accepted",100,365),checkCookie("co_role")||setCookie("co_role","001",365),hideModal("cookiebanner","slideDown"),hideModal("cookiebanner-config","slideDown"),deleteAllCookies(),$.ajax({url:"/libs/count.php",data:{optInActive:"1"},type:"POST",success:function(e){}})})),$(".cookieConf").on("click",(function(){hideModal("cookiebanner","slideToggle"),setTimeout((function(){displayModal("cookiebanner-config")}),1e3)})),$(".cookieBanner").on("click",(function(){hideModal("cookiebanner-config","slideToggle"),setTimeout((function(){displayModal("cookiebanner")}),1e3)})),window.onload=function(){var e=urlHasParam("om",null);null!=e&&displayModal(e)};

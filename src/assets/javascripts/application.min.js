...
class Navigation{constructor(){this.navigation=document.querySelector(".navigation"),this.checkScroll(),window.addEventListener("scroll",this.checkScroll.bind(this))}checkScroll(i){window.scrollY>0?this.navigation.classList.add("navigation--scrolled"):this.navigation.classList.remove("navigation--scrolled")}}new Navigation;
/*

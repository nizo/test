...
class Navigation{constructor(){this.navigation=document.querySelector(".navigation"),this.mobileButton=this.navigation.querySelector(".navigation__mobile-button"),this.mobileButton.addEventListener("click",this.handleMobileButton.bind(this)),this.checkScroll(),window.addEventListener("scroll",this.checkScroll.bind(this))}checkScroll(i){window.scrollY>0?this.navigation.classList.add("navigation--scrolled"):this.navigation.classList.remove("navigation--scrolled")}handleMobileButton(i){this.mobileButton.classList.toggle("navigation__mobile-button--active"),this.navigation.classList.toggle("navigation--mobile-open")}}new Navigation;
/*

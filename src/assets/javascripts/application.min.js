...
class Tablist{constructor(t){this.tablist=t,this.tabLinks=this.tablist.querySelectorAll(".tablist__link"),this.tabContents=this.tablist.querySelectorAll(".tablist__content"),this.activeIndex=0,this.tabLinks[this.activeIndex].classList.add("tablist__link--active"),this.addArrowButtons(),this.tabLinks.forEach(t=>t.addEventListener("click",this.switchTab.bind(this)))}switchTab(t){let s=t.currentTarget.dataset.tab;this.tabLinks.forEach((t,i)=>{t.dataset.tab===s?(t.classList.add("tablist__link--active"),this.activeIndex=i):t.classList.remove("tablist__link--active")}),this.tabContents.forEach(t=>{t.dataset.tab===s?t.classList.add("tablist__content--active"):t.classList.remove("tablist__content--active")})}prevTab(){this.activeIndex--,this.activeIndex<0&&(this.activeIndex=this.tabLinks.length-1),this.tabLinks.forEach(t=>t.classList.remove("tablist__link--active")),this.tabLinks[this.activeIndex].classList.add("tablist__link--active"),this.tabContents.forEach(t=>t.classList.remove("tablist__content--active")),this.tabContents[this.activeIndex].classList.add("tablist__content--active")}nextTab(){this.activeIndex++,this.activeIndex>=this.tabLinks.length&&(this.activeIndex=0),this.tabLinks.forEach(t=>t.classList.remove("tablist__link--active")),this.tabLinks[this.activeIndex].classList.add("tablist__link--active"),this.tabContents.forEach(t=>t.classList.remove("tablist__content--active")),this.tabContents[this.activeIndex].classList.add("tablist__content--active")}addArrowButtons(){let t=document.createElement("div");t.classList.add("tablist__arrow"),t.classList.add("tablist__arrow--left"),t.addEventListener("click",this.prevTab.bind(this));let s=document.createElement("div");s.classList.add("tablist__arrow"),s.classList.add("tablist__arrow--right"),s.addEventListener("click",this.nextTab.bind(this));let i=this.tablist.querySelector(".tablist__links");i.insertBefore(t,i.firstChild),i.appendChild(s)}}const lists=document.querySelectorAll(".tablist");lists.forEach(t=>new Tablist(t));

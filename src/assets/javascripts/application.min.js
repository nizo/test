...
for(var buttons=document.getElementsByClassName("openModal"),i=0;i<buttons.length;i++)buttons[i].addEventListener("click",(function(){var e,o=$(this).attr("data-modal");e=$(this).attr("data-title");var a=$(this).attr("data-modal-part");displayModal(o,null!=e?e:null,null!=a?a:null)}));if(!1===checkCookie("cookiebanner-accepted"))var x=setTimeout((function(){displayModal("cookiebanner")}),1e3);function displayModal(e,o,a){var n=document.getElementsByClassName(e)[0],t=document.getElementsByClassName("close");if(null!=n){if(n.style.display="block","priceCalc"===e){$(".formSuccess").hide();n.getElementsByClassName("title-"+a)[0];for(var l=n.getElementsByClassName(a)[0],i=(n.getElementsByClassName("defaultTitle")[0],n.getElementsByClassName("part")),s=0;s<i.length;s++)i[s].style.display="none";l.style.display="flex"}setTimeout((function(){$(".inputFields").css("display","block")}),500);n.addEventListener("click",(function(e){e.target==n&&$(n).fadeOut("fast")}));for(s=0;s<t.length;s++)t[s].addEventListener("click",(function(){$(n).fadeOut("fast")}))}}function hideModal(e,o){var a=document.getElementsByClassName(e)[0];switch(o){case"fadeOut":$(a).fadeOut("fast");break;case"slideToggle":$(a).slideToggle("slow");break;default:$(a).fadeOut("fast")}}$(".cookieSubmit").on("click",(function(e){e.preventDefault();var o=100;$(this).hasClass("full")?o=111:($("#CookieConf input#marketing").parent().hasClass("checked")&&(o+=10),$("#CookieConf input#extern").parent().hasClass("checked")&&(o+=1)),o>100&&loadLazyTracking(),setCookie("cookiebanner-accepted",o,365),checkCookie("co_role")||setCookie("co_role","001",365),hideModal("cookiebanner","slideDown"),hideModal("cookiebanner-config","slideDown")})),$(".cookieDeny").on("click",(function(e){e.preventDefault(),setCookie("cookiebanner-accepted",100,365),checkCookie("co_role")||setCookie("co_role","001",365),hideModal("cookiebanner","slideDown"),hideModal("cookiebanner-config","slideDown"),deleteAllCookies()})),$(".cookieConf").on("click",(function(){hideModal("cookiebanner","slideToggle"),setTimeout((function(){displayModal("cookiebanner-config")}),1e3)})),$(".cookieBanner").on("click",(function(){hideModal("cookiebanner-config","slideToggle"),setTimeout((function(){displayModal("cookiebanner")}),1e3)})),window.onload=function(){var e=urlHasParam("om",null);null!=e&&displayModal(e)};

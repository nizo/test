...
class Mehrwertrechner{constructor(e){this.element=e,this.defaultCalls=1234,this.defaultAgents=10,this.loader=this.element.querySelector(".atomic-loader"),this.h3=this.element.querySelector(".saving-calculation > h3"),this.h4=this.element.querySelector(".saving-calculation > h4"),this.detailToggles=this.element.querySelectorAll(".saving-calculation__toggle"),this.detailToggles.forEach(e=>e.style.display="none"),this.form=this.element.querySelector(".saving-calculation__form"),this.form.addEventListener("submit",this.submitForm.bind(this)),this.setDefaultFormValues()}setDefaultFormValues(){let e=this.form.querySelector('[name="calls"]'),t=this.form.querySelector('[name="agents"]');e.value=this.defaultCalls,t.value=this.defaultAgents}submitForm(e){e.preventDefault(),this.loader.classList.remove("atomic-loader--hidden"),this.h3.style.display="none",this.h4.textContent="Aufwendige Kalkulation...";let t=this.element.querySelector(".saving-calculation");t.classList.add("saving-calculation--loading"),t.querySelector(".saving-calculation__overlay").style.display="none",this.element.querySelectorAll(".saving-calculation__content").forEach(e=>e.classList.remove("saving-calculation__content--blurred")),this.detailToggles.forEach(e=>e.style.display="block");let l=this.element.querySelector(".saving-calculation__form-grid").querySelectorAll(".co-grid__col");l[0].classList.remove("co-grid__col--12-xs"),l[0].classList.remove("co-grid__col--6-xs"),l[1].style.display="block",setTimeout(()=>{this.loader.classList.add("atomic-loader--hidden"),this.h3.style.display="block",this.h4.textContent="Aufschlüsselung des Einsparpotenzials",t.classList.remove("saving-calculation--loading")},2e3)}}const mehrwertrechner=document.getElementById("mehrwertrechner");new Mehrwertrechner(mehrwertrechner);let savingCalculator=document.querySelector(".saving-calculation"),toggleButtons=savingCalculator.querySelectorAll(".saving-calculation__toggle");toggleButtons.forEach(e=>{e.addEventListener("click",t=>{let l=e.closest(".saving-calculation__col"),s=l.querySelector(".saving-calculation__details"),a=l.querySelector(".saving-calculation__content");s.classList.toggle("saving-calculation__details--open"),a.classList.toggle("saving-calculation__content--hidden"),e.classList.toggle("saving-calculation__toggle--close"),e.classList.toggle("saving-calculation__toggle--open"),e.classList.contains("saving-calculation__toggle--close")?e.textContent="Berechnung ausblenden":e.textContent="Berechnung einblenden"})});

...
var buttons=document.querySelectorAll(".openModal");buttons.forEach(e=>{e.addEventListener("click",o=>{let t=e.getAttribute("data-modal"),n=e.getAttribute("data-title")||null,l=e.getAttribute("data-modal-part")||null;displayModal(t,null!=n?n:null,null!=l?l:null)})});let urlQuery=window.location.search,params=new URLSearchParams(urlQuery);if(!params.has("no-banner")&&!1===checkCookie("cookiebanner-accepted"))var x=setTimeout((function(){displayModal("cookiebanner")}),1e3);function displayModal(e,o,t){var n=document.querySelector(".modal."+e),l=document.getElementsByClassName("close");if(null!=n){if(n.style.display="block","priceCalc"===e){document.querySelector(".formSuccess").style.display="none";n.getElementsByClassName("title-"+t)[0];for(var i=n.getElementsByClassName(t)[0],a=(n.getElementsByClassName("defaultTitle")[0],n.getElementsByClassName("part")),c=0;c<a.length;c++)a[c].style.display="none";i.style.display="flex"}setTimeout((function(){document.querySelectorAll(".inputFields").forEach(e=>e.style.display="block")}),500);n.addEventListener("click",(function(e){e.target==n&&fadeOut(n,300)}));for(c=0;c<l.length;c++)l[c].addEventListener("click",(function(){fadeOut(n,300)}))}}function hideModal(e,o){var t=document.getElementsByClassName(e)[0];switch(o){case"fadeOut":fadeOut(t,300);break;case"slideToggle":slideToggle(t,700);break;default:fadeOut(t,300)}}eventListener("click",".cookieSubmit",e=>{e.preventDefault(),console.log("Cookie Richtlinien akzeptiert.");var o=100;if(e.target.closest(".cookieSubmit").classList.contains("full")?o=111:(document.querySelector("#CookieConf input#marketing").parentNode.classList.contains("checked")&&(o+=10),document.querySelector("#CookieConf input#extern").parentNode.classList.contains("checked")&&(o+=1)),o>100&&(console.log("loadTracking"),loadLazyTracking(o>101)),o<110){let e=new FormData;e.set("optInActive","1"),fetch("/libs/count.php",{method:"POST",body:e}).then(e=>e.json()).then(e=>{console.log(e)}).catch(e=>{console.error(JSON.stringify(error))})}setCookie("cookiebanner-accepted",o,365),checkCookie("co_role")||setCookie("co_role","001",365),hideModal("cookiebanner","slideDown"),hideModal("cookiebanner-config","slideDown")}),eventListener("click",".cookieDeny",e=>{e.preventDefault(),console.log("Cookie Richtlinien widersprochen."),setCookie("cookiebanner-accepted",100,365),checkCookie("co_role")||setCookie("co_role","001",365),hideModal("cookiebanner","slideDown"),hideModal("cookiebanner-config","slideDown"),deleteAllCookies();let o=new FormData;o.set("optInActive","1"),fetch("/libs/count.php",{method:"POST",body:o}).then(e=>e.json()).then(e=>{console.log(e)}).catch(e=>{console.error(JSON.stringify(error))})}),eventListener("click",".cookieConf",e=>{console.log("Cookie Config."),hideModal("cookiebanner","slideToggle"),setTimeout((function(){displayModal("cookiebanner-config")}),1e3)}),eventListener("click",".cookieBanner",e=>{console.log("Cookie Start."),hideModal("cookiebanner-config","slideToggle"),setTimeout((function(){displayModal("cookiebanner")}),1e3)}),window.onload=function(){var e=urlHasParam("om",null);null!=e&&displayModal(e)};
...
class SmallTab{constructor(t){this.element=t,this.tabLinks=this.element.querySelectorAll(".small-tabs__tab"),this.tabContents=this.element.querySelectorAll(".small-tabs__content"),this.countTabs=this.tabLinks.length,this.setTabHeight(),setTimeout((t=>{this.setTabHeight()}).bind(this),100),window.addEventListener("resize",this.setTabHeight.bind(this)),this.tabLinks[0].classList.add("small-tabs__tab--active"),this.tabContents[0].classList.add("small-tabs__content--active"),this.tabLinks.forEach(t=>{t.addEventListener("click",this.switchTab.bind(this))})}setTabHeight(){let t=0;this.tabContents.forEach(s=>{s.style.height="auto";let a=!1;s.classList.contains("small-tabs__content--active")&&(a=!0),a||s.classList.add("small-tabs__content--active"),s.offsetHeight>t&&(t=s.offsetHeight),a||s.classList.remove("small-tabs__content--active")}),this.tabContents.forEach(s=>s.style.height=t+"px")}switchTab(t){let s=t.currentTarget.dataset.tab;this.tabLinks.forEach(t=>{t.classList.remove("small-tabs__tab--active"),s==t.dataset.tab&&t.classList.add("small-tabs__tab--active")}),this.tabContents.forEach(t=>{t.classList.remove("small-tabs__content--active"),s==t.dataset.tab&&t.classList.add("small-tabs__content--active")})}}document.addEventListener("DOMContentLoaded",t=>{document.querySelectorAll(".small-tabs").forEach(t=>new SmallTab(t))});

var app,navbar,slider;window.NodeList&&!NodeList.prototype.forEach&&(NodeList.prototype.forEach=Array.prototype.forEach),app={init:function(){return navbar.init(),this.bind_events(),this.init_slider(),this.loop_videos(),this.init_tabs()},bind_events:function(){return this,$(document).on("click",".tab-nav a",(function(e){var t;return e.preventDefault(),t=$(this).closest(".tabs"),$(".tab",t).removeClass("active"),$(".tab-nav a",t).removeClass("active"),$(this).addClass("active"),$(".tab#"+$(this).data("tab"),t).addClass("active")})),$(document).on("click",".form .submit",(function(e){return e.preventDefault(),$(this).parents(".js-form").hasClass("callback")?(console.log("send Callback"),sendCallback($(this).parents(".js-form"))):sendForm($(this).parents(".js-form"))})),$(document).on("click",".openBox",(function(e){var t,s;return e.preventDefault(),$(".SwitchBoxes").toggleClass("hidden"),t=$(this).text(),s=$(this).attr("data-text"),$(this).text(s),$(this).attr("data-text",t)})),$(document).on("click",".container .title",(function(e){return e.preventDefault(),$(this).parent().toggleClass("open"),$(this).next(".content").slideToggle("fast")})),$(document).on("click",".accordion",(function(e){if(e.preventDefault(),$(this).hasClass("open")){if($(this).hasClass("accordion-closeable"))return $(this).removeClass("open"),$(this).children(".content").slideUp("fast")}else if($(".accordion").removeClass("open"),$(this).addClass("open"),$(".accordion .content").slideUp("fast"),$(this).children(".content").slideDown("fast"),$(this).attr("data-link"))return console.log($(this).attr("data-area")),$($(this).attr("data-area")).children().hide(),$($(this).attr("data-area")).children($(this).attr("data-link")).fadeIn()})),$(document).on("click",".footer-menu li span",(function(e){return $(this).closest("li").hasClass("open")?$(this).closest("li").removeClass("open"):($(".footer-menu li").removeClass("open"),$(this).closest("li").addClass("open"))})),$(document).on("click",".mobile-nav .pages-menu .submenu",(function(e){return e.preventDefault(),e.stopPropagation(),$(this).hasClass("submenu-open")?($(this).removeClass("submenu-open"),$(this).next("ul").slideUp("fast")):($(".pages-submenu").slideUp("fast"),$(".pages-menu .submenu-open").removeClass("submenu-open"),$(this).addClass("submenu-open"),$(this).next("ul").slideDown("fast"))})),$(".btn-mobile-nav").on("click",(function(e){return e.preventDefault(),$(this).parent().next(".mobile-nav").addClass("open")})),$(".btn-mobile-nav.close").on("click",(function(e){return e.preventDefault(),$(this).parent(".mobile-nav").removeClass("open")})),$('a[href^="#"]').on("click",(function(e){var t,s;if(e.preventDefault(),s=this.hash)return t=$(s),$("html, body").stop().animate({scrollTop:t.offset().top-94},500,"swing",(function(){})),window.location.hash=s})),$(document).on("click",".showDiv",(function(e){return e.preventDefault(),$(this).next(".selection").toggleClass("active"),$(this).next(".selection").data("toggle"),$(this).next(".selection").hasClass("active")?$(this).next(".selection").slideDown():$(this).next(".selection").slideUp()})),$(document).on("click",".customCheckbox",(function(e){if($(".showField").addClass("active"),$(".showField").hasClass("active"))return $(".showField").fadeIn()})),$(document).on("click",".expertmode",(function(e){var t;return e.preventDefault(),$(this).toggleClass("active"),t=$(this).data("toggle"),$(this).hasClass("active")?($(".expertmode-on.expertmode-"+t).show(),$(".expertmode-off.expertmode-"+t).hide()):($(".expertmode-on.expertmode-"+t).hide(),$(".expertmode-off.expertmode-"+t).show())})),$(document).on("change",".topic",(function(e){var t,s;return s=$(this).val(),setCookie("co_role","00"+$(this).val(),365),$(".subtopic, .topic-box").hide(),$('.subtopic[data-subtopic="'+s+'"]').show(),t=$('.subtopic[data-subtopic="'+s+'"]').val(),$('.topic-box[data-topic="'+t+'"]').show()})),$(document).on("change",".subtopic",(function(e){var t;return t=$(this).val(),$(".topic-box").hide(),$('.topic-box[data-topic="'+t+'"]').show()})),$(document).on("click",".toggle-box label",(function(e){return $(".toggle-box",$(this).parent().parent()).each((t,s)=>{if(s!==e.currentTarget.parentNode)return $(".toggle-box__content",s).slideUp(),$("input",s).prop("checked",!1)}),$(this).parent().find(".toggle-box__content").slideToggle()})),$(".toggle-box").each((e,t)=>{if($("input",t).prop("checked"))return $(".toggle-box__content",t)[0].style.display="block"})},loop_videos:function(){return $.each($("video[data-loop]"),(function(e,t){var s;return s=parseFloat($(this).data("loop")),t.addEventListener("ended",(function(){return this.currentTime=s,this.play()}),!1)}))},init_tabs:function(){return $.each($(".tabs"),(function(e,t){return $(".tab-nav a:eq(0), .tab:eq(0)",$(this)).addClass("active")}))},init_slider:function(){return $.each($(".slider"),(function(e,t){return slider.init($(t))}))}},navbar={bar:document.querySelector(".navbar"),init:function(){return this.adjust(),document.addEventListener("scroll",(e=>this.adjust()).bind(this))},adjust:function(){if(this.bar)return window.scrollY>0?this.bar.classList.add("scrolled"):this.bar.classList.remove("scrolled")}},slider={slider:"",slides_box:"",slides:"",slider_height:0,slide_width:0,current_slide:0,init:function(e){return this.slider=e,this.slides_box=$(".slides",this.slider),this.slides=$(".slide",this.slider),this.get_slider_height(),this.init_slider_nav(),this.slide_width=$(this.slides[0]).outerWidth(),this.bind_events(),$(this.slides[0]).addClass("active"),$(this.slides[1]).addClass("active"),$(this.slides[2]).addClass("active")},bind_events:function(){var e;return e=this,$(window).resize((function(){return $(".slider .slide").css("width",$(".slider").outerWidth()/3+"px"),e.get_slider_height()}))},get_slider_height:function(){var e;return 173,e=this,$.each(this.slides,(function(t,s){if($(s).outerHeight()>e.slider_height)return e.slider_height=$(s).outerHeight()})),this.slider.css("height",this.slider_height+173+"px"),$(".slide-content",this.slider).css("height",this.slider_height+"px")},init_slider_nav:function(){var e,t,s;for(t=0,s=[];t<this.slides.length-2;)this,(e=$("<div class='btn-slider-nav' data-slide='"+t+"'></div>")).on("click",(function(e){var t,s;return slider=$(this).closest(".slider"),t=$(this).data("slide"),s=$(".slider").outerWidth()/3,$(".slides",slider).animate({left:t*s*-1+"px"},300),$(".btn-slider-nav",slider).removeClass("active"),$(".btn-slider-nav:eq("+t+")",slider).addClass("active"),$(".slide",slider).removeClass("active"),$(".slide:eq("+t+")",slider).addClass("active"),$(".slide:eq("+(t+1)+")",slider).addClass("active"),$(".slide:eq("+(t+2)+")",slider).addClass("active")})),0===t&&e.addClass("active"),$(".slider-navigation",this.slider).append(e),s.push(t++);return s}},$(document).ready((function(){var e,t,s,i,r,n,a,o,l;return app.init(),document.querySelectorAll(".customer-slider").forEach((function(e){var t,s,i,r;return i=1,r=e.querySelectorAll(".customer-slider__slide").length,t=e.querySelector(".customer-slider__arrow--left"),s=e.querySelector(".customer-slider__arrow--right"),e.querySelector(".customer-slider__slide:nth-child("+i+")").classList.add("customer-slider__slide--active"),t.addEventListener("click",(function(t){return e.querySelectorAll(".customer-slider__slide").forEach((function(e){return e.classList.remove("customer-slider__slide--active")})),0===--i&&(i=r),e.querySelector(".customer-slider__slide:nth-child("+i+")").classList.add("customer-slider__slide--active")})),s.addEventListener("click",(function(t){return e.querySelectorAll(".customer-slider__slide").forEach((function(e){return e.classList.remove("customer-slider__slide--active")})),++i>r&&(i=1),e.querySelector(".customer-slider__slide:nth-child("+i+")").classList.add("customer-slider__slide--active")}))})),a=function(e){var t;return(t=e.getBoundingClientRect()).top>=0&&t.left>=0&&t.bottom<=(window.innerHeight||document.documentElement.clientHeight)&&t.right<=(window.innerWidth||document.documentElement.clientWidth)},document.querySelectorAll(".tabset").forEach((function(e){var t;return e.querySelector(".tabset__tab:first-of-type").classList.add("tabset__tab--active"),e.querySelector(".tabset__link:first-of-type").classList.add("tabset__link--active"),t=e.querySelectorAll(".tabset__link"),window.addEventListener("scroll",(function(t){var s;if(s=e.querySelector(".tabset__tab:first-of-type .tabset__video video"),a(s)&&s.paused)return s.currentTime=0,s.loop=!0,s.muted=!0,s.play()})),t.forEach((function(t){return t.addEventListener("click",(function(s){var i;return e.querySelector(".tabset__tab--active").classList.remove("tabset__tab--active"),e.querySelector(".tabset__link--active").classList.remove("tabset__link--active"),e.querySelector('.tabset__tab[data-tab="'+t.dataset.tab+'"]').classList.add("tabset__tab--active"),e.querySelector('.tabset__link[data-tab="'+t.dataset.tab+'"]').classList.add("tabset__link--active"),(i=e.querySelector(".tabset__tab--active .tabset__video video")).currentTime=0,i.loop=!0,i.muted=!0,i.play()}),!1)}))})),document.querySelectorAll(".compare").forEach((function(e){var t;return(t=e.querySelector(".compare__switch input")).checked?e.querySelector('.compare__content[data-compare="on"]').classList.add("compare__content--active"):e.querySelector('.compare__content[data-compare="off"]').classList.add("compare__content--active"),t.addEventListener("change",(function(t){return e.querySelector('.compare__content[data-compare="off"]').classList.toggle("compare__content--active"),e.querySelector('.compare__content[data-compare="on"]').classList.toggle("compare__content--active")}),!1)})),25,500,document.querySelectorAll(".usercalc").length>0&&document.querySelectorAll(".usercalc").forEach((function(e){var t,s,i,a,o,l,c,d,u,h;return h=e.querySelector(".usercalc__users"),l=e.querySelector(".usercalc__price"),a=e.querySelector(".usercalc__form"),c=e.querySelector(".usercalc__result"),d=e.querySelectorAll(".usercalc__submit"),slider=e.querySelector(".usercalc__slider input"),u=e.querySelector(".usercalc__total span"),t=e.querySelector("#callcenter-software"),s=e.querySelector(".usercalc__callcenter"),i=247.5,o=!1,slider.addEventListener("input",(function(e){return h.value=parseInt(this.value),l.innerHTML=r(parseInt(this.value)),i=n(parseInt(this.value))}),!1),h.addEventListener("change",(function(e){var t;return(t=parseInt(this.value))<25||t>500?(h.value=25,slider.value=25,l.innerHTML=r(25),i=n(25)):(slider.value=t,l.innerHTML=r(this.value),i=n(this.value))})),t.addEventListener("change",(function(e){return o=this.checked})),d.forEach((function(e){return e.addEventListener("click",(function(e){var t;return e.preventDefault(),a.classList.toggle("usercalc__form--inactive"),c.classList.toggle("usercalc__result--active"),o?s.classList.add("usercalc__callcenter--active"):s.classList.remove("usercalc__callcenter--active"),t=Math.round(100*i)/100,u.innerHTML=t.toString().replace(".",",")+" &euro;"}))}))})),n=function(e){var t;return t=9.9,e>=50&&(t=8.9),e>=250&&(t=7.9),t*e},r=function(e){var t;return t="9,90 &euro;",e>=50&&(t="8,90 &euro;"),e>=250&&(t="7,90 &euro;"),t},"chrome",i="chrome",(i=-1!==navigator.userAgent.indexOf("Edg")||-1!==navigator.userAgent.indexOf("Edge")?"edge":-1!==navigator.userAgent.indexOf("Chrome")?"chrome":-1!==navigator.userAgent.indexOf("Firefox")?"firefox":-1!==navigator.userAgent.indexOf("MSIE")||!0==!!document.documentMode?"edge":"chrome")&&(t=document.querySelector('.installation__browser[data-browser="'+i+'"]'),s=document.querySelector('.installation__button[data-browser="'+i+'"]'),e=document.querySelector('.browsers__browser[data-browser="'+i+'"]'),t&&s&&(t.classList.add("installation__browser--active"),s.classList.add("installation__button--active")),e&&e.classList.add("browsers__browser--active")),document.querySelectorAll(".installation__browser").forEach((function(e){return e.addEventListener("click",(function(t){var s,r,n;if(t.preventDefault(),s=e.getAttribute("data-browser"),i!==s)return i=s,r=document.querySelector(".installation__browser--active"),n=document.querySelector(".installation__button--active"),r&&n&&(r.classList.remove("installation__browser--active"),n.classList.remove("installation__button--active")),document.querySelector('.installation__browser[data-browser="'+s+'"]').classList.add("installation__browser--active"),document.querySelector('.installation__button[data-browser="'+s+'"]').classList.add("installation__button--active")}))})),o=document.querySelectorAll(".scroller"),l=0,o.forEach((function(e){var t,s,i,r,n,a,c,d,u,h,v,_,f,p,m;if((e=o[l]).style.height=e.dataset.height+"px",m=e.dataset.height,_=e.querySelector(".scroller-belt"),(f=_.offsetHeight)>0){for(p=!1,e.hasAttribute("data-reversed")&&(p=!0),u=m,a=f,r=0;u>=a;)u-=a,r++;for(r++,h=_.innerHTML,d=0;d<r;)_.innerHTML+=h,d++;n=0,p&&(n=f),i=40,t=null,s=!1}return v=function(){var e;if(!s)return e=i/24,p?(n-=e)<=0&&(n=f):(n+=e)>=f&&(n=0),_.style.marginTop="-"+n+"px"},e.addEventListener("mouseenter",(function(e){return s=!0}),!1),e.addEventListener("mouseleave",(function(e){return s=!1}),!1),(c=function(){return clearInterval(t),window.innerWidth<=800?(n=p?f:0,_.style.marginTop="-"+n+"px"):t=setInterval(v,1e3/24)})(),window.addEventListener("resize",(function(e){return c()})),l++}))}));

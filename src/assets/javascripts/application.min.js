...
let savingCalculator=document.querySelector(".saving-calculation"),toggleButtons=savingCalculator.querySelectorAll(".saving-calculation__toggle");toggleButtons.forEach(l=>{l.addEventListener("click",t=>{let e=l.closest(".saving-calculation__col"),n=e.querySelector(".saving-calculation__details"),a=e.querySelector(".saving-calculation__content");n.classList.toggle("saving-calculation__details--open"),a.classList.toggle("saving-calculation__content--hidden"),l.classList.toggle("saving-calculation__toggle--close"),l.classList.toggle("saving-calculation__toggle--open"),l.classList.contains("saving-calculation__toggle--close")?l.textContent="Berechnung ausblenden":l.textContent="Berechnung einblenden"})});
...
class Tooltip{constructor(t){this.element=t,this.detectPosition(),this.element.addEventListener("mouseover",this.show.bind(this)),this.element.addEventListener("mouseleave",this.hide.bind(this))}show(){this.detectPosition(),this.element.classList.add("tooltip--open")}hide(){this.element.classList.remove("tooltip--open")}detectPosition(){let t=this.element.getBoundingClientRect(),e=window.innerHeight,i=this.element.querySelector("span");this.element.classList.add("tooltip--open");let o=i.getBoundingClientRect();this.element.classList.remove("tooltip--open"),t.y+o.height>e?this.element.classList.add("tooltip--top"):this.element.classList.remove("tooltip--top")}}const tooltips=document.querySelectorAll(".tooltip");tooltips.forEach(t=>{new Tooltip(t)});
...
class Tooltip{constructor(t){this.element=t,this.detectPosition(),window.addEventListener("scroll",this.detectPosition.bind(this))}detectPosition(){this.element.getBoundingClientRect();let t=window.innerHeight,e=this.element.querySelector("span");this.element.classList.add("tooltip--open");let o=e.getBoundingClientRect();this.element.classList.remove("tooltip--open"),o.y+o.height>t?this.element.classList.add("tooltip--top"):this.element.classList.remove("tooltip--top")}}const tooltips=document.querySelectorAll(".tooltip");tooltips.forEach(t=>{new Tooltip(t)});
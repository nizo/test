...
class Carddeck{constructor(d){this.deck=d,this.currentCard=0,this.speed=2e3,this.allCards=this.deck.querySelectorAll(".carddeck__card"),this.cardSize=this.getCardSize(),this.cards=this.initCards()}initCards(){let d=document.createElement("div");return d.classList.add("carddeck__cards"),d.style.height=this.cardSize+"px",this.allCards.forEach(d=>d.style.height=this.cardSize+"px"),this.allCards.forEach((c,e)=>{0==e?c.classList.add("carddeck__card--top"):1==e?c.classList.add("carddeck__card--center"):2==e?c.classList.add("carddeck__card--bottom"):c.classList.add("carddeck__card--hidden"),d.appendChild(c)}),this.deck.innerHTML="",this.deck.appendChild(d),d}initIndicators(){let d=document.createElement("div");return d.classList.add("carddeck__indicators"),d.style.height=this.cardSize+"px",this.allCards.forEach((c,e)=>{let t=document.createElement("div");t.classList.add("carddeck__indicator"),0==e&&t.classList.add("carddeck__indicator--active"),d.appendChild(t)}),this.deck.appendChild(d),d}getCardSize(){let d=0;return this.allCards.forEach(c=>{console.log(c.offsetHeight),c.offsetHeight>d&&(d=c.offsetHeight),c.classList.add("carddeck__card--messured")}),d}switch(){this.currentCard++;let d=this.allCards.length;this.currentCard>=d&&(this.currentCard=0);let c=((this.currentCard+2)%d+d)%d,e=this.allCards[c];e.classList.remove("carddeck__card--hidden");let t=this.cards.querySelector(".carddeck__card--bottom"),a=this.cards.querySelector(".carddeck__card--center"),r=this.cards.querySelector(".carddeck__card--top");this.cards.appendChild(e),e.classList.add("carddeck__card--bottom"),t.classList.toggle("carddeck__card--bottom"),t.classList.toggle("carddeck__card--center"),a.classList.toggle("carddeck__card--center"),a.classList.toggle("carddeck__card--top"),r.classList.toggle("carddeck__card--top"),r.classList.toggle("carddeck__card--fade"),setTimeout(()=>{r.classList.remove("carddeck__card--fade"),r.classList.add("carddeck__card--hidden")},310),this.indicators.querySelector(".carddeck__indicator--active").classList.remove("carddeck__indicator--active"),this.indicators.querySelectorAll(".carddeck__indicator")[this.currentCard].classList.add("carddeck__indicator--active")}}document.addEventListener("DOMContentLoaded",d=>{document.querySelectorAll(".carddeck").forEach(d=>{new Carddeck(d)})});

...
function setCookie(e,n,t){var o=new Date;o.setTime(o.getTime()+24*t*60*60*1e3);var r="expires="+o.toUTCString();document.cookie=e+"="+n+";"+r+";path=/"}function getCookie(e){for(var n=e+"=",t=decodeURIComponent(document.cookie),o=t.split(";"),r=0;r<o.length;r++){for(var c=o[r];" "==c.charAt(0);)c=c.substring(1);if(0==c.indexOf(n))return c.substring(n.length,c.length)}return""}function checkCookie(e){var n=getCookie(e);return""!=n?!0:!1}$(".trackedElement").on("click",function(){$(this).addClass("clicked")}),$(document).ready(function(){$(".form .showDiv").click(function(){$(".form-1 .selection .spinner").fadeIn(),$.post("https://connect.callone.io/backend/phonenumbers.php",{type:0},function(e,n){if("success"==n){$(".form-1 .selection .spinner").fadeOut("fast");var t="";$(".form-1 .selection").html(function(){for(var n=0;n<e.phonenumbers.length;n++)t+='<label for="'+n+'" class="customCheckbox"><input name="checkboxNumbers" type="checkbox" id="'+n+'" value="'+e.phonenumbers[n].number+'" />',t+=e.phonenumbers[n].number,t+='<span class="checkmark"></span></label>';return t})}else $(".form-1 .selection").html(function(){return t='<div class="error">Es ist ein Fehler beim laden der Rufnummern aufgetreten! Bitte versuchen Sie es später noch einmal.</div>'})})})});
...
document.addEventListener("DOMContentLoaded",function(){var e=[].slice.call(document.querySelectorAll("img.lazy")),t=[].slice.call(document.querySelectorAll(".lazyBackground")),n=!1;const i=function(){n===!1&&(n=!0,setTimeout(function(){e.forEach(function(t){t.style.visibility="hidden",t.getBoundingClientRect().top<=window.innerHeight+500&&t.getBoundingClientRect().bottom>=0&&"none"!==getComputedStyle(t).display&&(t.src=t.dataset.src,t.srcset=t.dataset.srcset,t.classList.remove("lazy"),t.style.visibility="visible",e=e.filter(function(e){return e!==t}),0===e.length&&(document.removeEventListener("scroll",i),window.removeEventListener("resize",i),window.removeEventListener("orientationchange",i)))}),t.forEach(function(e){e.getBoundingClientRect().top<=window.innerHeight+500&&e.getBoundingClientRect().bottom>=0&&"none"!==getComputedStyle(e).display&&e.classList.add("visible")}),n=!1},200))};document.addEventListener("scroll",i),document.addEventListener("click",i),window.addEventListener("resize",i),window.addEventListener("orientationchange",i),window.addEventListener("load",i)});
function displayModal(e){var t=document.getElementsByClassName(e)[0],o=document.getElementsByClassName("close");t.style.display="block";setTimeout(function(){$(".inputFields").css("display","block")},500);t.addEventListener("click",function(e){e.target==t&&$(t).fadeOut("fast")});for(var a=0;a<o.length;a++)o[a].addEventListener("click",function(){$(t).fadeOut("fast")})}function hideModal(e,t){var o=document.getElementsByClassName(e)[0];switch(t){case"fadeOut":$(o).fadeOut("fast");break;default:$(o).fadeOut("fast")}}for(var buttons=document.getElementsByClassName("openModal"),i=0;i<buttons.length;i++)buttons[i].addEventListener("click",function(){var e=$(this).attr("data-modal");displayModal(e)});if(!checkCookie("cookiebanner-accepted")){var x=setTimeout(function(){displayModal("cookiebanner")},1e3);setCookie("cookiebanner-accepted",1,90)}window.onscroll=function(){(document.body.scrollTop>450||document.documentElement.scrollTop>450)&&hideModal("cookiebanner","fadeOut")};
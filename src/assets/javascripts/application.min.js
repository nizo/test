...
class Carddeck{constructor(d){this.deck=d,this.currentCard=0,this.speed=parseInt(this.deck.dataset.speed)||2e3,this.allCards=this.deck.querySelectorAll(".carddeck__card"),this.wrapCardContent(),this.cardSize=this.getCardSize(),this.cards=this.initCards(),this.indicators=this.initIndicators(),this.deckInterval=setInterval(this.switch.bind(this),this.speed),respondToVisibility(this.deck,d=>{this.cardSize=this.getCardSize(),this.cards.style.height=this.cardSize+"px",this.allCards.forEach(d=>d.style.height=this.cardSize+"px"),this.indicators.style.height=this.cardSize+"px"})}wrapCardContent(){this.allCards.forEach(d=>{d.innerHTML="<div>"+d.innerHTML+"</div>"})}initCards(){let d=document.createElement("div");return d.classList.add("carddeck__cards"),d.style.height=this.cardSize+"px",this.allCards.forEach(d=>d.style.height=this.cardSize+"px"),this.allCards.forEach((e,t)=>{0==t?e.classList.add("carddeck__card--top"):1==t?e.classList.add("carddeck__card--center"):2==t?e.classList.add("carddeck__card--bottom"):e.classList.add("carddeck__card--hidden"),d.appendChild(e)}),this.deck.innerHTML="",this.deck.appendChild(d),d}initIndicators(){let d=document.createElement("div");return d.classList.add("carddeck__indicators"),d.style.height=this.cardSize+"px",this.allCards.forEach((e,t)=>{let c=document.createElement("div");c.classList.add("carddeck__indicator"),0==t&&c.classList.add("carddeck__indicator--active"),d.appendChild(c)}),this.deck.appendChild(d),d}getCardSize(){let d=0;return this.allCards.forEach(e=>{e.style.height="",e.classList.remove("carddeck__card--messured"),e.offsetHeight>d&&(d=e.offsetHeight),e.classList.add("carddeck__card--messured")}),d}switch(){this.currentCard++;let d=this.allCards.length;this.currentCard>=d&&(this.currentCard=0);let e=((this.currentCard+2)%d+d)%d,t=this.allCards[e];t.classList.remove("carddeck__card--hidden");let c=this.cards.querySelector(".carddeck__card--bottom"),a=this.cards.querySelector(".carddeck__card--center"),s=this.cards.querySelector(".carddeck__card--top");this.cards.appendChild(t),t.classList.add("carddeck__card--bottom"),c.classList.toggle("carddeck__card--bottom"),c.classList.toggle("carddeck__card--center"),a.classList.toggle("carddeck__card--center"),a.classList.toggle("carddeck__card--top"),s.classList.toggle("carddeck__card--top"),s.classList.toggle("carddeck__card--fade"),setTimeout(()=>{s.classList.remove("carddeck__card--fade"),s.classList.add("carddeck__card--hidden")},610),this.indicators.querySelector(".carddeck__indicator--active").classList.remove("carddeck__indicator--active"),this.indicators.querySelectorAll(".carddeck__indicator")[this.currentCard].classList.add("carddeck__indicator--active")}}document.addEventListener("DOMContentLoaded",d=>{document.querySelectorAll(".carddeck").forEach(d=>{new Carddeck(d)})});

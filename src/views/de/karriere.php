...
<div class="content wide centered">
    <div class="grid tile column flex">
      ...
      <div class="col-3 flex space-between row">
      	<div class="space-between flex column">
            <div class="grid">
...
<div class="content wide mobile-hidden">
    ...
    <p>Unser Team besteht aus klugen, sympathischen Menschen mit verschiedensten Skills und Interessen. Uns ist der persönliche Austausch wichtig, sowohl mit unseren Kunden, als auch innerhalb der Firma. Deshalb wissen wir unsere Persönlichkeiten und Fähigkeiten gegenseitig wertzuschätzen. Wir glauben, dass man in einem guten sozialen Umfeld die beste und erfüllendste Arbeit machen kann.</p>
        		</div>
  			</div>    
      		<div class="col-2">
            	<div class="padding">
              <h3 class="h1">Was wir tun</h3>
    <p>CallOne versorgt modern denkende Unternehmen mit Telefontechnologie, die ihren Kunden zugute kommt. Wir bauen effiziente Produkte, die Officetelefonie besser, schneller und freundlicher macht — zum Beispiel cloudbasierte Software, Schnittstellen und Apps zu Anbietern wie Zendesk, Salesforce oder Tableau.</p>
...
<div class="wrapper breather no-margin">

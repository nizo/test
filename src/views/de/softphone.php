  ...
  <div class="content wide">
    <header class="main-header">
      ...
      <div class="media centered mobile-hidden">
        <img src="/assets/images/screens/Intro-softphone-desktop.png" alt="Mit CallOne Softphone als Browser Extension direkt aus dem Browser telefonieren" width="560" height="428" />
      </div>
    </header>

    <p class="centered desktop-hidden margin-top-40">
      <img src="/assets/images/icons_svg/softphone-browser-circle.svg" alt="CallOne Softphone als Browser Extension" width="194" height="215" />
    </p>

    <p class="centered desktop-hidden margin-top-40">
      <img src="/assets/images/screens/Intro-Softphone-mobil.png" alt="Mit CallOne Softphone als Browser Extension direkt aus dem Browser telefonieren" width="720" height="931" />
    </p>

    ...
    <header class="main-header">
      <div class="text no-padding">
        ...
        <nav class="site-nav shadowbox">
       		<ul class="menu">
      			<li>
      				<a href="#konnektoren" class="arrow">Konnektoren</a>
      			</li>
      			<li>
      				<a href="#anbindungen" class="arrow">Anbindungen</a>
      			</li>
      			<li>
      				<a href="#apis" class="arrow">APIs</a>
      			</li>
      			<li>
...
<div class="wrapper" id="konnektoren">
  <div class="content wide centered">
    <strong class="uppercase">Ohne Programmierkenntnisse — fertige Konnektoren auf Knopfdruck</strong>
    <h2 class="h1">Kombinieren Sie Ihre bestehenden Business-Lösungen spielend einfach mit CallOne</h2>
    <p>Verbinden Sie Ihre CRM- oder Ticketing-Lösung mit unserer Telefonie.</p>
  </div>
</div>
...
<div class="wrapper" id="anbindungen">
  <div class="content wide">
  <h2 class="h1 centered">Tools für individuelle Reports: Vielleicht entdecken Sie ungenutzte Potenziale?</h2>
...
<div class="wrapper">
  <div class="content narrow centered">
      <h2 class="h1 centered">Anrufen per Klick auf beliebigen Webseiten - einfach per Browser-Erweiterung</h2>
      <p>Perfekte Integration in Ihre Outbound-Prozesse.</p>
  </div>
</div>  
  ...
  <div class="content wide">
      <div class="grid">
        <div class="col-2 padding">
			<h2 class="white">Fehlt Ihr CRM hier?</h2>
			<p class="white">Sicher arbeiten wir schon an einer Integration. Kontaktieren Sie uns doch einfach für eine individuelle Beratung und nutzen Sie unsere vielfältigen API für Ihre ganz eigene Anbindung.</p>
			<div class="button-set centered">
				<a href="/testen" class="button primary trackedElement" data-label="Button - Kontaktieren Sie uns" data-category="Link" data-action="linked to /testen">Kontaktieren Sie uns</a>
			</div>
        </div>
        <div class="col-2 padding">
...
<div class="wrapper" id="apis">
    <div class="content wide centered">
    	<h2 class="h1">Telefonie-Integrationen für Ihre eigenen Anwendungen und Apps. Nutzen Sie unsere vielfältigen Schnittstellen</h2>
    </div>
    <div class="content wide centered">
        <div class="grid">   
          <div class="col-3">
            <span class="sl sl-location sl-size-xl"></span>
            <h3>Call Tracking API</h3>
            <ul class="list approved-list">
            	<li>Anrufinformationen aus ACD und VoIP-Telefonanlage in Echtzeit erhalten</li>
				<li>Mit umfassender CTI (Computer Telephony Integration) intelligente Routing-Entscheidungen treffen</li>
				<li>Anrufinformationen an CRM oder Ticketing-Lösung übermitteln</li>            	
            </ul>
          </div>
          <div class="col-3">
            <span class="sl sl-call-out sl-size-xl"></span>
            <h3>Click-to-Call API</h3>
			<ul class="list approved-list">
            	<li>Outbound-Kampagnen über Click-to-Call Funktionen steuern</li>
				<li>Anrufe über API auslösen — egal ob stationäres Telefon oder Softphone-Client</li>
				<li>Einfache Einbindung in Ihre App, CRM oder Sales Tool</li>            	
            </ul>
          </div>
          <div class="col-3">
            ...
            <h3>Statistik API</h3>
            <ul class="list approved-list">
            	<li>Alle Statistiken in Echtzeit per API abrufbar und in andere Systeme integrierbar</li>
				<li>Informationen zu aus- und eingehenden Anrufen auf einen Blick</li>
				<li>Statistiken aus allen Bereichen: ACD, VoIP, PSTN, ACD-Agenten</li>            	
            </ul>
          </div>
          <div class="col-3">
            ...
            <h3>SMS API</h3>
            <ul class="list approved-list">
            	<li>Jederzeit SMS in Echtzeit an Kunden versenden</li>
				<li>Massenversand direkt über Prämiumrouten der Netzbetreiber</li>
				<li>Hinterlegen von eigenen Absenderkennungen möglich</li>            	
            </ul>
          </div>
          <div class="col-3">
            <span class="sl sl-volume sl-size-xl"></span>
            <h3>Text2Speech API</h3>
			<ul class="list approved-list">
            	<li>Pflegen Sie über die Schnittstelle verschiedenste Texte zur Verwendung im Routing ein</li>
				<li>Texte werden vollautomatisch je nach Routingverlauf angesagt</li>
				<li>Verfügbar in über 30 Sprachen mit einer Vielzahl von SprecherInnen</li>            	
            </ul>
          </div>
          <div class="col-3">
            ...
            <h3>DTMF API</h3>
            <ul class="list approved-list">
            	<li>Tasteneingaben (DTMF-Töne) empfangen und auf Ihre URL übermitteln</li>
				<li>Ideal zur Abfrage von Kunden- und Rechnungsnummern</li>
				<li>Routingentscheidungen auf Basis der Eingaben treffen</li>            	
            </ul>
          </div>
        </div>
  </div>
...
<div class="wrapper background">
  <div class="content wide">
      <div class="grid">
        <div class="col-2 padding">
			<h2 class="white">Sind Ihre Anforderungen komplexer?</h2>
			<p class="white">Haben Sie ein konkretes Projekt, in dem TAPIs und CTI-Integration (Computer Telephony Integration) eine Rolle spielen? Prima, denn das ist unser Spezialgebiet. Rufen Sie uns einfach an und wir besprechen Ihr Vorhaben.</p>
			<div class="button-set centered">
				<a href="/testen" class="button primary trackedElement" data-label="Button - Kontaktieren Sie uns" data-category="Link" data-action="linked to /testen">Kontaktieren Sie uns</a>
			</div>
        </div>
...
<div class="wrapper" id="nutzen">
  ...
  <h2 class="h1 centered">Ihre Vorteile</h2>
    <div class="shadow-box padding">
      <div class="image-grid">
        ...
        <div class="text">
        	<ul class="list approved-list">
            	<li>Schnelle und <strong>einfache Integration</strong> Ihrer CRM- und Businesslösungen</li>
				<li><strong>Kürzere Bearbeitungszeiten</strong> für ein- und ausgehende Anrufe</li>
				<li><strong>Vereinfachte Arbeitsprozesse</strong> durch Verknüpfung von Telefonie und Businesslösungen</li>
				<li>Einfache Implementierung einer <strong>umfangreichen CTI-Integration</strong></li>
				<li><strong>Daten an zentraler Stelle abfragen</strong> und dort einsetzen, wo sie den meisten Nutzen bringen</li>
				<li><strong>Optimierung der Auswertbarkeit</strong> Ihrer Daten, z.B. direkt im CRM</li>    
            </ul>
        </div>
      </div>    
    </div>
...
<div class="wrapper half-background">
  <div class="content narrow">
    <h2 class="h2 centered">Kundenmeinungen</h2>
    <p class="centered">Ob sich das lohnt? Fragen Sie unsere Kunden.</p>

                ...
                <div class="expandable expandable--no-border expandable--shadow">
                    <div class="expandable__main expandable__main--small-padding">
                        <div class="co-grid">
                            ...
                            <div class="co-grid__col co-grid__col--fill co-grid__col--vcentered">
                                <h4>Einbindung eigener Hardware</h4>
                            </div>
                        </div>
                    </div>
                ...
                <div class="expandable expandable--no-border expandable--shadow">
                    <div class="expandable__main expandable__main--small-padding">
                        <div class="co-grid">
                            ...
                            <div class="co-grid__col co-grid__col--fill co-grid__col--vcentered">
                                <h4>Browser-Anruf (Click2Call)</h4>
                            </div>
                        </div>
                    </div>
                ...
                <div class="expandable expandable--no-border expandable--shadow">
                    <div class="expandable__main expandable__main--small-padding">
                        <div class="co-grid">
                            ...
                            <div class="co-grid__col co-grid__col--fill co-grid__col--vcentered">
                                <h4>Öffnungszeiten administrieren</h4>
                            </div>
                        </div>
                    </div>
                ...
                <div class="expandable expandable--no-border expandable--shadow">
                    <div class="expandable__main expandable__main--small-padding">
                        <div class="co-grid">
                            ...
                            <div class="co-grid__col co-grid__col--fill co-grid__col--vcentered">
                                <h4>Individuelle ACD Konfiguration</h4>
                            </div>
                        </div>
                    </div>
                ...
                <div class="expandable expandable--no-border expandable--shadow">
                    <div class="expandable__main expandable__main--small-padding">
                        <div class="co-grid">
                            ...
                            <div class="co-grid__col co-grid__col--fill co-grid__col--vcentered">
                                <h4>Display-Anzeigen & Whispering</h4>
                            </div>
                        </div>
                    </div>
                ...
                <div class="expandable expandable--no-border expandable--shadow">
                    <div class="expandable__main expandable__main--small-padding">
                        <div class="co-grid">
                            ...
                            <div class="co-grid__col co-grid__col--fill co-grid__col--vcentered">
                                <h4>Umfangreiche Routingoptionen</h4>
                            </div>
                        </div>
                    </div>

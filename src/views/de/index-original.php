    ...
    <div class="shadow-box">
      <div class="image-grid">
        <div class="text">
          ...
          <div class="button-set">
            <a href="/cti-schnittstellen" class="button primary" title="Sales - CRM Callcenter">Mehr erfahren</a>
          </div>
        </div>
        <div class="image padding">
          <img class="lazy" src="/assets/images/photos/placeholder.gif" data-src="/assets/images/icons_svg/big_08.svg" data-srcset="/assets/images/icons_svg/big_08.svg" alt="Sales — Outbound Dialer &amp; CRM / CTI" title="Sales — Outbound Dialer &amp; CRM" />
        </div>
      </div>
    </div>
    ...
    <div class="shadow-box">
      <div class="image-grid">
        ...
        <div class="text">
          ...
          <div class="button-set">
            <a href="/voip-telefonanlage" class="button primary" title="Businesstelefonie - VoIP / Cloud Telefonanlage">Mehr erfahren</a>
          </div>
        </div>
      </div>
    </div>

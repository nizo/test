...
<div class="section section--light-green">
    <div class="section__content section__content--wide">
        <div class="content-box content-box--white content-box--shadow content-box--full-width">
            <div class="quote" style="--fontSize:36px">
...
<div class="section">
    <div class="section__content section__content--narrow">
        <p class="centered mobile-left bigtext">Flaconi.de ist einer der größten Onlineversandhändler Deutschlands für Parfum, Pflege und Make-up. Als Premium Online-Shop wird höchster Wert auf ein exzellentes Einkaufserlebnis und erstklassigen Service gelegt.</p>
    </div>
</div>

<div class="section">
    <div class="section__content section__content--narrow">
        ...
        <p>Die CallOne GmbH (nachfolgend <b>„CallOne“</b> oder <b>"wir"</b>) betreibt die unter der Domain „www.callone.de“ abrufbare Webseite (nachfolgend <b>„Webseite“</b>). Im Folgenden informieren wir über die Erhebung personenbezogener Daten bei Nutzung dieser Webseite.  Personenbezogene Daten sind alle Daten, die auf Sie persönlich beziehbar sind, also z.B. Name, Adresse, E-Mail-Adressen, Nutzerverhalten.</p>
        <p>Ihre Daten werden nach den Bestimmungen des Telemediengesetzes (TMG) und des Datenschutzrechts, insbesondere des Bundesdatenschutzgesetzes (BDSG) und der Datenschutz-Grundverordnung (DSGVO) erhoben, verarbeitet und genutzt. Mittels dieser Datenschutzerklärung informieren wir über die Erhebung von personenbezogenen Daten auf und über unsere Webseite bei der betroffenen Person nach Art. 13 DSGVO.</p>

        <hr class="divider">

        <h2>1. Erhebung personenbezogener Daten bei informatorischer Nutzung</h2>
        <p>(1) Bei der bloß informatorischen Nutzung der Website, also wenn Sie sich nicht zur Nutzung der Website anmelden, registrieren oder uns sonst Informationen übermitteln, erheben wir keine personenbezogenen Daten, mit Ausnahme der Daten, die Ihr Browser übermittelt. Zweck dieser Datenerhebung ist es, Ihnen den Besuch der Website zu ermöglichen und die Funktionsfähigkeit der Website sicherzustellen. Zudem dienen uns die Daten zur Optimierung der Website und zur Sicherstellung der Sicherheit unserer informationstechnischen Systeme. Diese sind:</p>
        ...
        <p>Sie können Ihre Browser-Einstellung entsprechend Ihren Wünschen konfigurieren und z.B. die Annahme von Third-Party-Cookies oder allen Cookies ablehnen. Informationen über die Verwaltung und Löschung von Cookies sowie eine entsprechende Anleitung hierzu für die gängigen Browser sind zudem unter <a href="https://www.ddow.de/" class="inline-link">www.ddow.de</a> abrufbar. Wir weisen Sie jedoch darauf hin, dass Sie dann eventuell nicht alle Funktionen dieser Website nutzen können.</p>

        <p>3) Diese gespeicherten Informationen werden getrennt von eventuell weiter bei uns angegeben Daten gespeichert. Insbesondere werden die Daten der Cookies nicht mit Ihren weiteren Daten, sofern solche übermittelt werden, verknüpft.</p>

        <hr class="divider">

        <h2>2. Erhebung personenbezogener Daten bei personalisierter Nutzung</h2>
        <p>Neben der rein informatorischen Nutzung unserer Website bieten wir verschiedene Leistungen an, die Sie bei Interesse nutzen können. Dazu müssen Sie in der Regel weitere persönliche Daten angeben, die wir zur Erbringung der jeweiligen Leistung nutzen. Wenn zusätzliche freiwillige Angaben möglich sind, sind diese entsprechend gekennzeichnet. Es werden von uns nur diejenigen personenbezogenen Daten erhoben, verarbeitet und genutzt, die für Ihre Nutzung der Webseite und/oder die Erfüllung eines mit uns geschlossenen Vertrages erforderlich sind oder die Sie selber angeben. Es handelt sich hierbei insbesondere um folgende Bestandsdaten und Nutzungsdaten, die möglicherweise über Formulare auf unserer Webseite übermittelt werden können:</p>
        ...
        <p>Wir sind berechtigt, für Zwecke der Werbung, der Marktforschung oder zur bedarfsgerechten Gestaltung der Webseite Nutzungsprofile unter Verwendung von Pseudonymen zu erstellen, sofern Sie dem nicht widersprechen. Insbesondere werten wir die Nutzungsdaten zu statistischen Zwecken anonym aus, um die Webseite bedarfsgerecht zu gestalten. Sie können dieser Verwendung Ihrer personenbezogenen Daten durch Mitteilung an uns widersprechen.</p>
        ...
        <p>(3) Sie können die Speicherung der Cookies durch eine entsprechende Einstellung Ihrer Browser-Software verhindern; wir weisen Sie jedoch darauf hin, dass Sie in diesem Fall gegebenenfalls nicht sämtliche Funktionen dieser Website vollumfänglich werden nutzen können.</p>
        <p>(4) Sie können darüber hinaus die Erfassung der durch das Cookie erzeugten und auf Ihre Nutzung der Website bezogenen Daten (inkl. Ihrer IP-Adresse) an Google sowie die Verarbeitung dieser Daten durch Google verhindern, indem sie das unter dem folgenden Link verfügbare Browser-Plug-in herunterladen und installieren: <a href="https://tools.google.com/dlpage/gaoptout?hl=de" class="inline-link">tools.google.com/dlpage/gaoptout</a>.</p>
        <p>(5) Diese Website verwendet Google Analytics mit der Erweiterung „_anonymizeIp()“. Dadurch werden IP-Adressen gekürzt weiterverarbeitet, eine direkte Personenbeziehbarkeit kann damit ausgeschlossen werden.</p>
        <p>(6) Die Nutzung von Google Analytics erfolgt in Übereinstimmung mit den Voraussetzungen, auf die sich die deutschen Datenschutzbehörden mit Google verständigten. Informationen des Drittanbieters: Google Dublin, Google Ireland Ltd., Gordon House, Barrow Street, Dublin 4, Ireland, Fax: +353 (1) 436 1001. Nutzerbedingungen: <a href="https://marketingplatform.google.com/about/analytics/terms/de/" class="inline-link">marketingplatform.google.com/about/analytics/terms/de/</a>, Übersicht zum Datenschutz: <a href="https://marketingplatform.google.com/about/" class="inline-link">marketingplatform.google.com/about/</a>, sowie die Datenschutzerklärung: <a href="https://policies.google.com/privacy?hl=de&gl=de" class="inline-link">policies.google.com/privacy</a>.</p>
        ...
        <p>
            <strong>(1) Art und Zweck der Verarbeitung</strong><br>
        ...
        <p>
            <strong>(5) Bereitstellung vorgeschrieben oder erforderlich</strong><br>
        ...
        <p>(1) Wir setzen im Rahmen der Verarbeitung der personenbezogenen Daten Unterauftragnehmer ein und schließen mit diesen Auftragsverarbeitern einen Vertrag gemäß den Anforderungen des Art. 28 DSGVO.</p>
        <p>Als Unterauftragnehmer zum Hosting der Webseite wird <b>Host Europe GmbH</b> eingesetzt.</p>

        <p>
            (2) Empfänger Ihrer personenbezogenen Daten sind neben den bereits genannten Unternehmen folgende Unternehmen:<br/>
            Zendesk Inc., Rheinsberger Straße 73, 10115 Berlin, Tel. 030 30808524
        </p>

        <hr class="divider">

        <h2>10. Schutz der personenbezogenen Daten</h2>
        <p>Wir treffen technische und organisatorische Maßnahmen gemäß den Anforderungen von Art. 32 DSGVO zum Schutz der personenbezogenen Daten des Nutzers. Alle unsere Mitarbeiter, die mit der Verarbeitung personenbezogener Daten beschäftigt sind, sind auf das Datengeheimnis verpflichtet. Personenbezogenen Daten des Nutzers werden bei der Übermittlung an die Webseite mittels HTTPS verschlüsselt.</p>
        ...
        <h2>12. Keine automatisierte Entscheidungsfindung / kein Profiling</h2>
        ...
        <p>Sie haben zudem das Recht, sich bei einer Datenschutz-Aufsichtsbehörde über die Verarbeitung Ihrer personenbezogenen Daten durch uns zu beschweren (Art. 77 DSGVO).</p>

        <hr class="divider">

        <h2>15. Hinweis auf das Widerspruchsrecht nach Art. 21 DSGVO</h2>
        <p>
            <strong>A. Widerspruchsrecht aufgrund der besonderen Situation</strong>><br />
        ...
        <p>
            <strong>B. Widerspruchsrecht bei Direktwerbung</strong><br />
        ...
        <h2>16. Diensteanbieter / Verantwortliche Stelle / Kontaktdaten / Widerspruch / Widerruf einer Einwilligung</h2>
        ...
        <p>Die für uns zuständige Datenschutzaufsichtsbehörde, bei der eine Beschwerde über eine Verletzung von Datenschutzrecht eingereicht werden kann, ist:</p>

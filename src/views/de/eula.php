...
<head>   
    <meta charset="utf-8"/>
    <title>EULA - Cloud Callcenter Software, VoIP-Telefonanlagen, weltweite Rufnummern | CallOne</title>
    <meta name="description" content="VoIP-Telefonanlage und Callcenter Software &quot;all-in-one&quot; mit CTI-Integration aus der deutschen Cloud. Keine Hardware oder Softphones notwendig. Jetzt testen!" />
    <meta name="viewport" content="width=device-width,initial-scale=1.0" />
    <meta name="google-site-verification" content="Sqndy6_j8hwq2O67oeDnHTdNmKPDaCRcC-g_K3FRYfE" />

    <meta property="og:title" content="EULA - Cloud Callcenter Software, VoIP-Telefonanlagen, weltweite Rufnummern"/>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="https://www.callone.de/assets/images/favicons/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="https://www.callone.de/assets/images/favicons/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="https://www.callone.de/assets/images/favicons/favicon-16x16.png">
    <link rel="manifest" href="https://www.callone.de/assets/images/favicons/site.webmanifest">
    <link rel="mask-icon" href="https://www.callone.de/assets/images/favicons/safari-pinned-tab.svg" color="#86ed18">
    <link rel="shortcut icon" href="https://www.callone.de/assets/images/favicons/favicon.ico">
    ...
    <meta name="msapplication-TileImage" content="https://www.callone.de/assets/images/favicons/mstile-144x144.png">
    <meta name="msapplication-config" content="https://www.callone.de/assets/images/favicons/browserconfig.xml">
    ...
    <link rel="stylesheet" href="/assets/stylesheets/application.min.css?build=347638e6959bb7efb074f110d901ef32" />
...
<div class="section">
    <div class="section__content section__content--narrow">
        <h1 class="centered mobile-left">Endbenutzer-Lizenzvertrag (EULA)</h1>
        <br />
        <p class="subtext">
            für das CallOne Softphone (bezeichnet als „Software“)<br />
            WICHTIG! – BITTE LESEN SIE DIE BEDINGUNGEN DIESER LIZENZVEREINBARUNG SORGEFÄLTIG, bevor sie die Installation des Programms fortsetzen. 
        </p>
        ...
        <p>CallOne besitz alle Markenschutzrechte und Eigentumsrechte, einschließlich Copyrights in der Software und für die Software und aller Kopien davon (einschließlich und ohne Beschränkung aller in die Software integrierten Bildern sowie Video und Audiotext) und begleitender Datenträger und gedruckter Materialien. Das Kopieren der Software oder eines Teils davon ist durch diese Gesetze und Abkommensbestimmungen streng verboten. </p>
        <p>Der Endbenutzer-Lizenzvertrag gilt für die Installation der CallOne Softphone Software auf Ihrem PC, Mac oder mobilen Endgerät. Mit der Installation und Nutzung der Software stimmen Sie den in diesem Vertrag aufgeführten Bedingungen zu. Die Bedingungen müssen durch Sie zugestimmt werden, bevor Sie das Produkt nutzen können. Dieser Endbenutzer-Lizenzvertrag legt ausschließlich Ihre Rechte und Pflichten als Endbenutzer dieser Software dar. Der Vertrag hat keinerlei Auswirkungen auf die Nutzung der CallOne Telefonanlage und dem zwischen dem Lizenzgeber und dem Kunden des Lizenzgeber („Kunde“) geschlossenen Vertrag.</p>
        <p>Durch Bestätigung der Schaltfläche „Zustimmen“ erkennen Sie den Vertrag für als bindend an. Sollten Sie mit den Bedingungen nicht einverstanden sein, brechen Sie bitte die Installation des Softphones ab.</p>
        <p>
            HINWEIS: <br />
            Die Software bietet keinen Ersatz für ein Mobil- oder Festnetztelefon. Dies bedeutet unter anderem auch, dass ein Notruf nur dann abgesetzt werden kann, wenn die Software über eine stabile und funktionierende Breitbandverbindung verfügt. Treffen Sie bitte daher entsprechende Vorkehrungen, um im Bedarfsfall einen Notruf absetzen zu können.
        </p>
        ...
        <p>1.4. Der Lizenznehmer erkennt an, dass die Software das ausschließliche Eigentum von CallOne und deren Lizenzgeber ist und wertvolle Geschäftsgeheimnisse enthält. Der Lizenznehmer erklärt sich bereit, die Software in Übereinstimmung mit den Bestimmungen dieses Vertrags streng vertraulich zu unterhalten. Der Lizenznehmer stimmt zu, dass jegliches Versäumnis bezüglich des streng vertraulichen Unterhalts der Software seitens des Lizenznehmers CallOne irreparable Schäden zufügt, und CallOne daher einen Anspruch auf angemessene Entschädigung, ohne irreparable Schäden zu demonstrieren oder eine Kaution zu erbringen.</p>
        <p>1.5. Der Lizenznehmer nimmt zur Kenntnis, dass CallOne nicht personenbezogene identifizierbare Informationen über Ihre Produkte und die Verwendung der Produkte erheben und aufzeichnen kann, um CallOne bei der Entwicklung neuer Produkte und der Verbesserung des Betriebs und der Funktion Ihrer Produkte zu unterstützen. Der Lizenzgeber ist berechtigt, diese Informationen in anonymisierter Form zur Verbesserung seiner Produkte oder im Rahmen der Bereitstellung von Services bzw. Technologien an Sie zu nutzen sowie an Dritte weiterzugeben.</p>
        ...
        <p>4.4. Die Gewährleistung ist ausgeschlossen. </p>
        ...
        <p>Der Lizenznehmer verpflichtet sich, den Lizenzgeber und dessen Handlungsbevollmächtigte, Direktoren, angestellte und Zulieferer von allen Verlusten, Schäden, Geldstrafen und Ausgaben (einschließlich Anwaltshonorare und juristische Kosten), die sich aufgrund oder im Zusammenhang mit einer Nutzung des Produkts ergeben, mit der die Rechte dritter verletzt wurden oder mit der gegen ein Gesetz verstoßen wurde, zu schützen, freizustellen und schadlos zu halten.</p>

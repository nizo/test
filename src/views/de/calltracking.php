...
<div class="wrapper">
  ...
  <div class="content narrow centered">
    <div class="button-set centered">
    	...
    	<a href="#" class="button secondary trackedElement" data-openmodal="contact-sales" data-label="Button - Mit Experten sprechen" data-category="Link" data-action="linked to /testen">Mit Experten sprechen</a>
    </div>
  </div>
</div>
    ...
    <div class="wrapper breather parallel thirdcolor">
      <div class="content thin small h_text">
        ...
        <div class="button-set">
          <a href="#" target="_blank" class="button primary trackedElement" data-openmodal="contact-sales" data-label="Button - Jetzt mit einem Experten sprechen" data-category="Link" data-action="linked to /testen">Jetzt mit einem Experten sprechen</a>
        </div>
      </div>
    </div>
</div>

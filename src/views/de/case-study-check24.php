    ...
    <div class="hero">
        <div class="hero__text">
            <h1>
                ...
                Beste Telefonanlage? <br class="mobile-hidden" />Check!
            </h1>
            ...
            <div class="co-grid">
                <div class="co-grid__col co-grid__col--12-xs co-grid__col--6-lg">
                    <ul class="list list--checkmarks list--checkmarks-green">
                        ...
                        <li>Auswertung aller <br class="mobile-hidden" />Daten mit Tableau</li>
                    </ul>
                </div>
                <div class="co-grid__col co-grid__col--12-xs co-grid__col--6-lg">
                    <ul class="list list--checkmarks list--checkmarks-green">
                        <li>VoIP-Telefonanlage</li>
                        <li>durchschnittliche <br class="mobile-hidden" />Wartezeit &lt; 1 Min.</li>
                    </ul>
                </div>
            </div>
        </div>
...
<div class="section" id="video">
    <div class="section__content section__content--narrow">
        <h2 class="centered mobile-left">Umfassende Callcenter Software mit BI-Integration für den Bereich Sachversicherungen</h2>
    </div>
        ...
        <div class="breather-box" style="--c-bg:#031C3A;--c-text:#fff">
            <div class="co-grid co-grid--no-margin-top co-grid--no-margin-bottom">
                ...
                <div class="co-grid__col co-grid__col--12-xs co-grid__col--9-sm co-grid__col--vcentered">
                    <h4>Check24 über die CallOne Lösung:</h4>
    ...
    <div class="section__content section__content--wide">
        <div class="co-grid">
            <div class="co-grid__col co-grid__col--12-xs co-grid__col--7-md">
                ...
                <p class="bigtext">Gemeinsam mit Check24 hat CallOne in verschiedenen Workshops und einer ausführlichen Teststellung eine Lösung erarbeitet, die die Anforderungen an eine neue VoIP-Telefonanlage ganzheitlich erfüllen und darüber hinaus erweitern konnte.</p>
            </div>
            <div class="co-grid__col co-grid__col--12-xs co-grid__col--5-md">
                <p class="bigtext"><strong>Die eingesetzten Bausteine beinhalten drei zentrale CallOne Produkte:</strong></p>
            ...
            <div class="co-grid__col co-grid__col--12-xs co-grid__col--6-md">
                <div class="content-box content-box--white content-box--shadow content-box--full-width">
                    <div class="co-grid">
                        ...
                        <div class="co-grid__col co-grid__col--fill co-grid__col--vcentered">
                            <h3>Intelligentes Warteschleifen&shy;management</h3>
                        </div>
                    </div>
    ...
    <div class="section__content section__content--wide">
        <div class="co-grid centered">
            <div class="co-grid__col co-grid__col--12-xs co-grid__col--4-md co-grid__col--vcentered">
                <div class="content-box content-box--white content-box--shadow content-box--full-width">
                    <h3>durchschnittliche Wartedauer &lt; 1 Min.</h3>
                </div>
            </div>
            <div class="co-grid__col co-grid__col--12-xs co-grid__col--4-md co-grid__col--vcentered">
                <div class="content-box content-box--white content-box--shadow content-box--full-width">
...
<div class="section">
    <div class="section__content section__content--narrow">
        <div class="breather-box" style="--c-bg:#031C3A;--c-text:#fff">
            <div class="quote" style="--fontSize:28px">

...
$faqs->faq_add (
    ...
    '<p>Wir sind sicher nicht der günstigste Anbieter am Markt. Fragt man jedoch unsere Kunden sparen Sie mit CallOne täglich eine Menge Geld. Wie? Mit smarten Telefonanlagenfunktionen in Paarung mit optimalem Consulting durch unsere Projektmanager. Schlagworte sind hier: <a href="/statistiken" class="inline-link">Effizientere Personalsteuerung</a>,  <a href="/callcenter-bot" class="inline-link">Kürzere Gesprächsdauern durch Automatisierung</a>, <a href="/telefonanlage-mit-warteschleife" class="inline-link">Wettbewerbsvorteile durch erfolgreichen Kundenservice</a>.</p>'
);
$faqs->faq_add (
    'Was unterscheidet CallOne von alternativen Telefonanlagen-Anbietern?',
    '<p>Wir bieten Ihnen das vielleicht breiteste Portfolio rundum die Cloud Telefonie. Natürlich versorgen wir Ihr Unternehmen problemlos mit Basics wie Cloud Telefonanlagen, SIP-Trunks, Rufnummernschaltung und Portierung. Und wenn Sie für Ihren Kundenservice und Ihre Inside-Sales Abteilung eine maßgeschneiderte Call Center Software wollen, bieten wir Ihnen auch das.</p><p>Bei CallOne stehen Sie als Kunde wirklich im Mittelpunkt: Unsere Projektmanager und Schnittstellenprogrammierer erstellen eine Kommunikationslösung, die genau zu Ihrem Bedarf und Ihren Ansprüchen passt.</p><p>Im Ergebnis stehen wir für ein <a href="/callcenter-einsparpotential" class="inline-link">Einsparpotential</a>, dass sich durch mehr Effizienz, besserer Planbarkeit und Transparenz und damit schlussendlich einem nachweisbaren höheren ROI ergibt.</p>'
);
$faqs->faq_add (

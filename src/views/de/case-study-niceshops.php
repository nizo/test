        ...
        <div class="content-box content-box--white content-box--full-width content-box--shadow">
            <div class="co-grid">
                ...
                <div class="co-grid__col co-grid__col--12-xs co-grid__col--8-md co-grid__col--vcentered">
                    <div class="quote" style="--fontSize:30px">
...
<div class="section section--light-green-white">
    ...
    <div class="section__content section__content--wide">
        <div class="content-box content-box--full-width content-box--white content-box--shadow content-box--white">
            <div class="co-grid">
...
<div class="section">
    ...
    <div class="section__content">
        <div class="content-box content-box--full-width content-box--shadow">
            ...
            <p>Routings für die verschiedenen Shops und Länder werden bei Niceshops angereichert mit einer intelligenten <a href="/freshdesk-callcenter-software" title="Freshdesk-Integration">Freshdesk-Integration</a>. Durch einfaches Mapping von CallOne und Freshdesk, wird für jeden Anruf in Echtzeit ein Voice-Ticket erstellt und automatisiert dem richtigen Agent und Produkt zugeordnet. Mit Hilfe von Browsertelefonie und der CallOne Agentenmaske ist die Kundenservice- und Officetelefonie für Niceshops nun spielend einfach.</p>
            ...
            <div class="co-grid centered">
                <div class="co-grid__col co-grid__col--12-xs co-grid__col--4-md">
                    ...
                    <p class="btn-set btn-set--centerd">
                        <a href="/voip-telefonanlage" class="btn btn--secondary">Unsere VoIP-Telefonlösung</a>
                    </p>
                </div>
                <div class="co-grid__col co-grid__col--12-xs co-grid__col--4-md">
                    <?= pictureTag(
                    ...
                    <p class="btn-set btn-set--centerd">
                        <a href="/callcenter-software" class="btn btn--secondary">Unsere Callcenter-Software</a>
                    </p>
                </div>
                <div class="co-grid__col co-grid__col--12-xs co-grid__col--4-md">
                    <?= pictureTag(
                    ...
                    <p class="btn-set btn-set--centerd">
                        <a href="/freshdesk-callcenter-software" class="btn btn--secondary">Unsere Freshdesk-Integration</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="btn-set btn-set--centered">
            <a href="#" class="btn btn--primary" data-openmodal="contact-sales" data-label="Button Header -Jetzt kostenlos Testen" data-category="Link" data-action="Show Contact Modal">Jetzt kostenlos Testen</a>
        </div>
    </div>
</div>
...
<div class="section section--light-green-white">
    ...
    <div class="section__content">
        <div class="content-box content-box--full-width content-box--shadow content-box--white">
            <div class="co-grid">
                <div class="co-grid__col co-grid__col--12-xs co-grid__col--5-md co-grid__col--order-1-xs co-grid__col--vcentered">
                    <?= pictureTag(
        ...
        <div class="content-box content-box--full-width content-box--shadow content-box--white">
            <div class="co-grid">
                ...
                <div class="co-grid__col co-grid__col--12-xs co-grid__col--7-md co-grid__col--order-2-xs co-grid__col--vcentered">
                    <h3>Einfache und skalierbare Telefonie</h3>
                    <ul class="list list--checkmarks list--checkmarks-green">

  	...
  	<div class="grid flex">
  		<div class="col-2 flex space-between">
			<div class="padding" style="height: 100%"> 
            	...
            	<ul class="list approved-list-black">
            		<li>Der Online-Auftritt der CallOne wird deine Spielwiese </li>
            		<li>Du übernimmst die Planung, Entwicklung und technische Umsetzung von statischen, dynamischen und mobilen Webseiten der CallOne</li>
            		<li>Für unsere namenhaften Kunden schaffst Du gemeinsam mit Deinen Kollegen aus der Programmierung webbasierte Benutzeroberflächen, die Spaß machen</li>
            	</ul>
    		</div>
		</div>    
  		<div class="col-2 flex space-between">
        	<div class="padding" style="height: 100%">
            	...
            	<ul class="list approved-list-black">
            		<li>Abgeschlossenes Studium oder Ausbildung in Grafikdesign, Mediendesign, Kommunikationsdesign oder vergleichbarem </li>
            		<li>Gute Kenntnisse in HTML5 und CSS3 (SASS), JS</li>
            		<li>Kreativität und ein besonders ausgeprägtes Gefühl für modernes und ansprechendes Design und Weblayout</li>
            		<li>Sicherer Umgang mit modernen Design Tools wie z.B. Figma</li>
            		<li>Begeisterungsfähigkeit und Wissendurst</li>
					<li>Eigenständige und zuverlässige Arbeitsweise, sowie die Eigeninitiative das ganze Team mit deinen Ideen voranzutreiben </li>
            	</ul>
        	</div>

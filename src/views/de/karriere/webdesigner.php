<script type="application/ld+json">
{
  ...
  "hiringOrganization": {
    ...
    "url": "https://www.callone.de/karriere/job-webdesigner-potsdam",
    "logo": "https://www.callone.de/assets/images/logo/callone-logo-square.jpg"
  },
  "datePosted": "2019-11-04",
  "title": "Webdesigner (m/w/d) in Potsdam",
  "validThrough": "2020-09-30T00:00",
  "description": "  <p>Gestatten, CallOne: die Zukunft der Telekommunikation. Online, cloudbasiert, mit neuster Technologie. 
                    ...
                    <p>
                        ...
                        <ul>
            		      <li>Der Online-Auftritt der CallOne wird deine Spielwiese</li>
					      <li>Du übernimmst die Planung und Entwicklung von statischen, dynamischen und mobilen Webseiten der CallOne</li>
					      <li>Für unsere namenhaften Kunden schaffst Du gemeinsam mit Deinen Kollegen aus der Programmierung webbasierte Benutzeroberflächen, die Spaß machen</li>
            	       </ul>
                    </p>
                    <p>
                        <strong>Was wir uns wünschen</strong><br>
                        <ul>
            		      <li><strong>Abgeschlossenes Studium oder Ausbildung</strong> in Grafikdesign, Mediendesign, Kommunikationsdesign oder vergleichbarem</li>
        			      <li>Gute Kenntnisse in HTML5 und CSS3 (SASS)</li>
        			      <li>Kreativität und ein besonders ausgeprägtes Gefühl für modernes und ansprechendes Design und Weblayout</li>
        			      <li>Sicherer Umgang mit den gängigen Grafikprogrammen wie Photoshop oder Fireworks</li>
        			      <li>Begeisterungsfähigkeit und Wissendurst</li>
  ...
  "image": "https://www.callone.de/assets/images/icons_png/job_03.png",
  ...
  <div class="content wide">
    <header class="main-header">
      <div class="media centered mobile-hidden">
        <img src="/assets/images/photos/placeholder.gif" data-src="/assets/images/icons_svg/job_big_03.svg" data-srcset="/assets/images/icons_svg/job_big_03.svg" class="lazy" alt="Webdesigner in Potsdam" title="Webdesigner in Potsdam" />
      </div>
      <div class="text">
        ...
        <p class="primary mobile-hidden">
	       	Wir haben es uns zum Ziel gesetzt Kundenservice richtig gut zu machen. Dafür brauchen wir dich! HTML-Programmier-Dienstleistungen und Grafikdesign sind dein tägliches Handwerk? Dann bist du bei uns genau richtig!
	    </p>	    
...
<div class="wrapper mobile-hidden quarter-background" id="more">
  <div class="content wide centered">
    ...
    <div class="shadow-box padding">
		...
		<p class="padding-top-40">Als <strong>Webdesigner</strong> kümmerst du dich um das Wohl unserer Kunden auf unseren Webpräsenzen. 
      	Du pflegst und erweiterst unser CD, erstellst passende Grafiken für unsere Social Media Kanäle und vieles mehr. 
      	Du bringst eine gute Portion Neugier und Kreativität mit sowie die Fähigkeit, dich mit neuen Ideen mit einzubringen.</p>
	</div>
  </div>
  		...
  		<div class="col-2 flex space-between">
			<div class="shadow-box padding" style="height: 100%"> 
            	...
            	<ul class="list approved-list">
            		<li>Der <strong>Online-Auftritt</strong> der CallOne wird deine Spielwiese</li>
					<li>Du übernimmst die <strong>Planung und Entwicklung</strong> von statischen, dynamischen und mobilen Webseiten der CallOne</li>
					<li>Für unsere <strong>namenhaften Kunden</strong> schaffst Du gemeinsam mit Deinen Kollegen aus der Programmierung <strong>webbasierte Benutzeroberflächen</strong>, die Spaß machen</li>
            	</ul>
    		</div>
		</div>    
  		<div class="col-2 flex space-between">
        	<div class="shadow-box padding" style="height: 100%">
            	...
            	<ul class="list approved-list">
            		<li><strong>Abgeschlossenes Studium oder Ausbildung</strong> in Grafikdesign, Mediendesign, Kommunikationsdesign oder vergleichbarem</li>
        			<li>Gute Kenntnisse in <strong>HTML5 und CSS3 (SASS)</strong></li>
        			<li><strong>Kreativität</strong> und ein besonders ausgeprägtes Gefühl für modernes und ansprechendes Design und Weblayout</li>
        			<li>Sicherer Umgang mit den <strong>gängigen Grafikp rogrammen</strong> wie Photoshop oder Fireworks</li>
        			<li><strong>Begeisterungsfähigkeit und Wissendurst</strong></li>
        			<li><strong>Eigenständige und zuverlässige Arbeitsweise</strong>, sowie die Eigeninitiative das ganze Team mit deinen Ideen voranzutreiben</li>
            	</ul>
        	</div>
        </div>
  	</div>

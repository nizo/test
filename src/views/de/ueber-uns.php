    ...
    <div class="section__content section__content--wide">
        <div class="co-grid">
            ...
            <div class="co-grid__col co-grid__col--12-xs co-grid__col--5-md co-grid__col--vcentered">
                ...
                <p>
                    <a href="/case-study-check24" class="btn btn--primary mobile-hidden">Zu Kundengeschichten</a>
                    <a href="/case-study-check24" class="btn btn--primary btn--full-width centered desktop-hidden">Zu Kundengeschichten</a>
                </p>

...
<div class="section section--white-grey">
    <div class="section__content section__content--wide" id="geschichte">
        <div class="co-grid">
            ...
            <div class="co-grid__col co-grid__col--6-md co-grid__col--hidden-md co-grid__col--vcentered">
                <div class="collage">
                    <div class="collage__big">
                        <img src="/assets/images/photos/collage-background-1.png" alt="" />
                    </div>
    ...
    <div class="section__content section__content--wide" id="kultur">
        <h1 class="desktop-hidden">Unsere Kultur</h1>
        <div class="co-grid">
            ...
            <div class="co-grid__col co-grid__col--12-xs co-grid__col--7-sm co-grid__6-md co-grid__col--vcentered">
                <h1 class="mobile-hidden">Unsere Kultur</h1>
    ...
    <div class="section__content section__content--wide">
        <div class="co-grid">
            ...
            <div class="co-grid__col co-grid__col--12-xs co-grid__col--5-md co-grid__col--vcentered">
                ...
                <!-- TODO: Add link -->
                <p>
                    <a href="#todo" class="btn btn--primary mobile-hidden">Zu Kundengeschichten</a>
                    <a href="#todo" class="btn btn--primary btn--full-width centered desktop-hidden">Zu Kundengeschichten</a>
                </p>

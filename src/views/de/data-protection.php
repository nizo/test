        ...
        <div class="tablist" id="ausfaelle-notfaelle">
            <div class="tablist__links">
                <div class="tablist__link" data-tab="1">
                    <img src="/assets/images/icons_svg/reliability-icon.svg" alt="" />
                    <strong>Ausfallsicherheit</strong>
                </div>
                <div class="tablist__link" data-tab="2">
                    <img src="/assets/images/icons_svg/emergency-icon.svg" alt="" />
            ...
            <div class="tablist__content" data-tab="1">
                    ...
                    <div class="expandable__main">
                        <div class="co-grid">
                            ...
                            <div class="co-grid__col co-grid__col--5-xs co-grid__col--vcentered">
                                <img src="/assets/images/illus/georedundancy-illustration.svg" alt="" />
                            </div>
                        </div>
                    </div>
                ...
                <div class="expandable mobile-hidden">
                    <div class="expandable__main">
                        <div class="co-grid">
                            <div class="co-grid__col co-grid__col--5-xs co-grid__col--vcentered">
                                <img src="/assets/images/illus/ddos-illustration.svg" alt="" />
                            </div>
                            <div class="co-grid__col co-grid__col--7-xs co-grid__col--vcentered">
                ...
                <div class="expandable mobile-hidden">
                    <div class="expandable__main">
                        <div class="co-grid">
                            ...
                            <div class="co-grid__col co-grid__col--5-xs co-grid__col--vcentered">
                                <img src="/assets/images/illus/hardware-illustration.svg" alt="" />
                            </div>
                        </div>
                    </div>
                ...
                <div class="expandable mobile-hidden">
                    <div class="expandable__main">
                        <div class="co-grid">
                            <div class="co-grid__col co-grid__col--5-xs co-grid__col--vcentered">
                                <img src="/assets/images/illus/backup-illustration.svg" alt="" />
                            </div>
                            <div class="co-grid__col co-grid__col--7-xs co-grid__col--vcentered">
                                <h3>Back it up</h3>
            ...
            <div class="tablist__content" data-tab="2">
                ...
                <div class="expandable mobile-hidden">
                    <div class="expandable__main">
                        <div class="co-grid">
                            ...
                            <div class="co-grid__col co-grid__col--5-xs co-grid__col--vcentered">
                                <img src="/assets/images/illus/backup-routing-illustration.svg" alt="" />
                            </div>
                        </div>
                    </div>
                ...
                <div class="expandable mobile-hidden">
                    <div class="expandable__main">
                        <div class="co-grid">
                            <div class="co-grid__col co-grid__col--5-xs co-grid__col--vcentered">
                                <img src="/assets/images/illus/announcement-illustration.svg" alt="" />
                            </div>
                            <div class="co-grid__col co-grid__col--7-xs co-grid__col--vcentered">
                ...
                <div class="expandable mobile-hidden">
                    <div class="expandable__main">
                        <div class="co-grid">
                            ...
                            <div class="co-grid__col co-grid__col--5-xs co-grid__col--vcentered">
                                <img src="/assets/images/illus/routing-change-illustration.svg" alt="" />
                            </div>
                        </div>
                    </div>
                ...
                <div class="expandable mobile-hidden">
                    <div class="expandable__main">
                        <div class="co-grid">
                            <div class="co-grid__col co-grid__col--5-xs co-grid__col--vcentered">
                                <img src="/assets/images/illus/emergency-call-illustration.svg" alt="" />
                            </div>
                            <div class="co-grid__col co-grid__col--7-xs co-grid__col--vcentered">
                ...
                <div class="expandable mobile-hidden">
                    <div class="expandable__main">
                        <div class="co-grid">
                            <div class="co-grid__col co-grid__col--5-xs co-grid__col--vcentered">
                                <img src="/assets/images/illus/external-callcenter-illustration.svg" alt="" />
                            </div>
                            <div class="co-grid__col co-grid__col--7-xs co-grid__col--vcentered">
...
<div class="section section--black" id="datenschutz">
    <div class="section__content section__content--wide">
        <p class="centered mobile-left">
            <img src="/assets/images/icons_svg/law-love-icon.svg" alt="" /><br />
            <br />
        </p>
        ...
        <div class="content-box content-box--white-datenschutz content-box--full-width mobile-hidden">
            <div class="co-grid co-grid--no-margin-top co-grid--no-margin-bottom">
                <div class="co-grid__col co-grid__col--12-xs co-grid__col--7-md">
                    <p><img src="/assets/images/icons_svg/dsvgo-icon.svg" alt="" /></p>
                    ...
                    <div class="carddeck carddeck--right">
                        <div class="carddeck__card">
                            <p class="bigtext">
                                <img src="/assets/images/icons_svg/vpn-icon.svg" alt="" style="vertical-align:middle" /> VPN
                            </p>
                            <p class="subtext">Direkte, vollständige Verschlüsselung der Datenverbindung zwischen Endgerät und Server.</p>
                        </div>
                        <div class="carddeck__card">
                            <p class="bigtext">
                                <img src="/assets/images/icons_svg/sip-icon.svg" alt="" style="vertical-align:middle" /> SIP
                            </p>
                            <p class="subtext">Sichere Übertragung Ihrer Gespräche mit SIP-Transport.</p>
                        </div>
                        <div class="carddeck__card">
                            <p class="bigtext">
                                <img src="/assets/images/icons_svg/srtp-icon.svg" alt="" style="vertical-align:middle" /> SRTP
                            </p>
        ...
        <div class="tablist tablist--on-black mobile-hidden">
            ...
            <div class="tablist__content" data-tab="1">
                <div class="co-grid">
                    <div class="co-grid__col co-grid__col--6-xs co-grid__col--vcentered">
                        <img src="/assets/images/illus/private-cloud-illustration.svg" alt="" />
                    </div>
                    <div class="co-grid__col co-grid__col--6-xs co-grid__col--vcentered">
            ...
            <div class="tablist__content" data-tab="2">
                <div class="co-grid">
                    <div class="co-grid__col co-grid__col--6-xs co-grid__col--vcentered">
                        <img src="/assets/images/illus/internal-dataprotection-illustration.svg" alt="" />
                    </div>
                    <div class="co-grid__col co-grid__col--6-xs co-grid__col--vcentered">
                        <h6>Mehr Schutz</h6>
        ...
        <div class="content-box content-box--white-on-black desktop-hidden">
            <p class="centered">
                <img src="/assets/images/icons_svg/dsvgo-germany-icon-group.svg" alt="" />
            </p>
        ...
        <div class="content-box content-box--white desktop-hidden">
            ...
            <img src="/assets/images/illus/private-cloud-mobile-illustration.svg" alt="" />
        </div>

        <div class="content-box content-box--white desktop-hidden">
            <h6>Mehr Schutz</h6>
            <h4 style="margin-top:0">Interner Datenschutz</h4>
            <img src="/assets/images/illus/internal-dataprotection-mobile-illustration.svg" alt="" />
        </div>
    </div>
</div>

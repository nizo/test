...
$faqs->faq_add (
	...
	'<p>Unternehmen, die in Sales und Service viel telefonieren, können mit einer <a href="https://www.callone.de/callcenter-software">Callcenter Software</a> (auch ACD genannt) Ihre Telefonie effizient managen. Eine ACD kommt mit <a href="https://www.callone.de/callcenter-software-funktionen">Funktionen</a> wie Warteschleifen, Routingoptionen und Callbacks. Auch die Anbindung an eigene Ticketing-Systeme (CRM-Systeme) und die Integration in eigene Business-Systeme ist für eine gute Callcenter Software sehr wichtig. 

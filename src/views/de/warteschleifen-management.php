    ...
    <div class="section__content section__content--wide">
        ...
        <div class="tablist" id="features">
            <div class="tablist__links">
                <div class="tablist__link" data-tab="1" style="--bg: 219, 0, 197;">
                    <img src="/assets/images/icons_svg/callback-icon.svg" alt="" width="70" height="70" />
                    <strong>Warteschleifenmodule</strong>
                </div>
                <div class="tablist__link" data-tab="2" style="--bg: 219, 0, 197;">
                    ...
                    <div class="expandable__extra">
                        <div class="expandable__extra-left">
                            ...
                            <ul class="list list--checkmarks-top bigtext">
                                <li>Automatisierter Rückruf bei dem Agent- und Anrufer*in zu einem zuvor vorgeschlagenen Termin angerufen werden</li>
                                <li>Konfigurierbare Anwahlreihenfolge und frei definierbare Zeitslots</li>
                                <li>Administierbar über die Weboberfläche</li>
                            </ul>
                        </div>

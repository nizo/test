...
<div class="wrapper">
  <div class="content wide">
    ...
    <div class="button-set centered">
      <a href="#integrations" class="button icon"><span class="button__icon icon-integrations"></span> Integration &amp; API</a>
      ...
      <a href="#reporting" class="button icon"><span class="button__icon icon-reporting"></span> Reporting</a>
    </div>
  </div>
</div>
